 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const La=new Map,Ru=new Map;function RS(t,e){try{t.container.addComponent(e)}catch(n){Ws.debug(`Component ${e.name} failed to register with FirebaseApp ${t.name}`,n)}}function Cn(t){const e=t.name;if(Ru.has(e))return Ws.debug(`There were multiple attempts to register component ${e}.`),!1;Ru.set(e,t);for(const n of La.values())RS(n,t);return!0}function Oc(t,e){const n=t.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),t.container.getProvider(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ni=CS;function hy(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const s=Object.assign({name:Su,automaticDataCollectionEnabled:!1},e),i=s.name;if(typeof i!="string"||!i)throw cs.create("bad-app-name",{appName:String(i)});if(n||(n=yC()),!n)throw cs.create("no-options");const r=La.get(i);if(r){if(Ma(n,r.options)&&Ma(s,r.config))return r;throw cs.create("duplicate-app",{appName:i})}const o=new FC(i);for(const c of Ru.values())o.addComponent(c);const a=new kS(n,s,o);return La.set(i,a),a}function Dc(t=Su){const e=La.get(t);if(!e&&t===Su)return hy();if(!e)throw cs.create("no-app",{appName:t});return e}function Vt(t,e,n){var s;let i=(s=SS[t])!==null&&s!==void 0?s:t;n&&(i+=`-${n}`);const r=i.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const a=[`Unable to register library "${i}" with version "${e}":`];r&&a.push(`library name "${i}" contains illegal characters (whitespace or "/")`),r&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Ws.warn(a.join(" "));return}Cn(new fn(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const NS="firebase-heartbeat-database",OS=1,Zr="firebase-heartbeat-store";let xl=null;function dy(){return xl||(xl=YC(NS,OS,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(Zr)}}}).catch(t=>{throw cs.create("idb-open",{originalErrorMessage:t.message})})),xl}async function DS(t){try{return(await dy()).transaction(Zr).objectStore(Zr).get(fy(t))}catch(e){if(e instanceof kn)Ws.warn(e.message);else{const n=cs.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Ws.warn(n.message)}}}async function Mp(t,e){try{const s=(await dy()).transaction(Zr,"readwrite");return await s.objectStore(Zr).put(e,fy(t)),s.done}catch(n){if(n instanceof kn)Ws.warn(n.message);else{const s=cs.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});Ws.warn(s.message)}}}function fy(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ks=new yo("@firebase/firestore");function Jp(){return Ks.logLevel}function $(t,...e){if(Ks.logLevel<=fe.DEBUG){const n=e.map(pd);Ks.debug(`Firestore (${sr}): ${t}`,...n)}}function Hn(t,...e){if(Ks.logLevel<=fe.ERROR){const n=e.map(pd);Ks.error(`Firestore (${sr}): ${t}`,...n)}}function Bu(t,...e){if(Ks.logLevel<=fe.WARN){const n=e.map(pd);Ks.warn(`Firestore (${sr}): ${t}`,...n)}}function pd(t){if(typeof t=="string")return t;try{return e=t,JSON.stringify(e)}catch{return t}/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class It{constructor(e){this.binaryString=e}static fromBase64String(e){const n=atob(e);return new It(n)}static fromUint8Array(e){const n=function(s){let i="";for(let r=0;r<s.length;++r)i+=String.fromCharCode(s[r]);return i}(e);return new It(n)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return e=this.binaryString,btoa(e);var e}toUint8Array(){return function(e){const n=new Uint8Array(e.length);for(let s=0;s<e.length;s++)n[s]=e.charCodeAt(s);return n}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return ye(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}It.EMPTY_BYTE_STRING=new It("");const rA=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function ps(t){if(ke(!!t),typeof t=="string"){let e=0;const n=rA.exec(t);if(ke(!!n),n[1]){let i=n[1];i=(i+"000000000").substr(0,9),e=Number(i)}const s=new Date(t);return{seconds:Math.floor(s.getTime()/1e3),nanos:e}}return{seconds:Qe(t.seconds),nanos:Qe(t.nanos)}}function Qe(t){return typeof t=="number"?t:typeof t=="string"?Number(t):0}function Bi(t){return typeof t=="string"?It.fromBase64String(t):It.fromUint8Array(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vv(t){var e,n;return((n=(((e=t==null?void 0:t.mapValue)===null||e===void 0?void 0:e.fields)||{}).__type__)===null||n===void 0?void 0:n.stringValue)==="server_timestamp"}function wv(t){const e=t.mapValue.fields.__previous_value__;return vv(e)?wv(e):e}function ao(t){const e=ps(t.mapValue.fields.__local_write_time__.timestampValue);return new Ye(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pt{constructor(e,n,s){this.converter=n,this._key=s,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new ls(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new Pt(this.firestore,e,this._key)}}class xo{constructor(e,n,s){this.converter=n,this._query=s,this.type="query",this.firestore=e}withConverter(e){return new xo(this.firestore,e,this._query)}}class ls extends xo{constructor(e,n,s){super(e,n,Yc(s)),this._path=s,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new Pt(this.firestore,null,new K(e))}withConverter(e){return new ls(this.firestore,e,this._path)}}function qi(t,e,...n){if(t=$e(t),pw("collection","path",e),t instanceof rl){const s=Fe.fromString(e,...n);return Ig(s),new ls(t,null,s)}{if(!(t instanceof Pt||t instanceof ls))throw new W(R.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const s=t._path.child(Fe.fromString(e,...n));return Ig(s),new ls(t.firestore,null,s)}}function Ld(t,e,...n){if(t=$e(t),arguments.length===1&&(e=_v.R()),pw("doc","path",e),t instanceof rl){const s=Fe.fromString(e,...n);return bg(s),new Pt(t,null,new K(s))}{if(!(t instanceof Pt||t instanceof ls))throw new W(R.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const s=t._path.child(Fe.fromString(e,...n));return bg(s),new Pt(t.firestore,t instanceof ls?t.converter:null,new K(s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kw(t){t=Qt(t,Pt);const e=Qt(t.firestore,ms);return TN(ol(e),t._key).then(n=>Nw(e,t,n))}class jd extends PN{constructor(e){super(),this.firestore=e}convertBytes(e){return new Wi(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new Pt(this.firestore,null,n)}}function LN(t){t=Qt(t,xo);const e=Qt(t.firestore,ms),n=ol(e),s=new jd(e);return Sw(t._query),bN(n,t._query).then(i=>new Aw(e,s,t,i))}function FN(t,e,n,...s){t=Qt(t,Pt);const i=Qt(t.firestore,ms),r=ww(i);let o;return o=typeof(e=$e(e))=="string"||e instanceof al?NN(r,"updateDoc",t._key,e,n,s):kN(r,"updateDoc",t._key,e),qd(i,[o.toMutation(t._key,un.exists(!0))])}function UN(t){return qd(Qt(t.firestore,ms),[new vd(t._key,un.none())])}function BN(t,e){const n=Qt(t.firestore,ms),s=Ld(t),i=xN(t.converter,e);return qd(n,[AN(ww(t.firestore),"addDoc",s._key,i,t.converter!==null,{}).toMutation(s._key,un.exists(!1))]).then(()=>s)}function Hd(t,...e){var n,s,i;t=$e(t);let r={includeMetadataChanges:!1},o=0;typeof e[o]!="object"||Rg(e[o])||(r=e[o],o++);const a={includeMetadataChanges:r.includeMetadataChanges};if(Rg(e[o])){const h=e[o];e[o]=(n=h.next)===null||n===void 0?void 0:n.bind(h),e[o+1]=(s=h.error)===null||s===void 0?void 0:s.bind(h),e[o+2]=(i=h.complete)===null||i===void 0?void 0:i.bind(h)}let c,l,u;if(t instanceof Pt)l=Qt(t.firestore,ms),u=Yc(t._key.path),c={next:h=>{e[o]&&e[o](Nw(l,t,h))},error:e[o+1],complete:e[o+2]};else{const h=Qt(t,xo);l=Qt(h.firestore,ms),u=h._query;const d=new jd(l);c={next:p=>{e[o]&&e[o](new Aw(l,d,h,p))},error:e[o+1],complete:e[o+2]},Sw(t._query)}return function(h,d,p,g){const _=new Fd(g),w=new Pd(d,_,p);return h.asyncQueue.enqueueAndForget(async()=>Nd(await Xa(h),w)),()=>{_.bc(),h.asyncQueue.enqueueAndForget(async()=>Od(await Xa(h),w))}}(ol(l),u,a,c)}function qd(t,e){return function(n,s){const i=new Bn;return n.asyncQueue.enqueueAndForget(async()=>iN(await EN(n),s,i)),i.promise}(ol(t),e)}function Nw(t,e,n){const s=n.docs.get(e._key),i=new jd(t);return new Rw(t,i,e._key,s,new Rr(n.hasPendingWrites,n.fromCache),e.converter)}(function(t,e=!0){(function(n){sr=n})(ni),Cn(new fn("firestore",(n,{instanceIdentifier:s,options:i})=>{const r=n.getProvider("app").getImmediate(),o=new ms(new WR(n.getProvider("auth-internal")),new QR(n.getProvider("app-check-internal")),function(a,c){if(!Object.prototype.hasOwnProperty.apply(a.options,["projectId"]))throw new W(R.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new oo(a.options.projectId,c)}(r,s),r);return i=Object.assign({useFetchStreams:e},i),o._setSettings(i),o},"PUBLIC").setMultipleInstances(!0)),Vt(Xp,"3.8.3",t),Vt(Xp,"3.8.3","esm2017")})();function Wd(t,e){var n={};for(var s in t)Object.prototype.hasOwnProperty.call(t,s)&&e.indexOf(s)<0&&(n[s]=t[s]);if(t!=null&&typeof Object.getOwnPropertySymbols=="function")for(var i=0,s=Object.getOwnPropertySymbols(t);i<s.length;i++)e.indexOf(s[i])<0&&Object.prototype.propertyIsEnumerable.call(t,s[i])&&(n[s[i]]=t[s[i]]);return n}function Ow(){return{["dependent-sdk-initialized-before-auth"]:"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const $N=Ow,Dw=new Zi("auth","Firebase",Ow());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class es extends Bo{constructor(){super("facebook.com")}static credential(e){return Gs._fromParams({providerId:es.PROVIDER_ID,signInMethod:es.FACEBOOK_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return es.credentialFromTaggedObject(e)}static credentialFromError(e){return es.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return es.credential(e.oauthAccessToken)}catch{return null}}}es.FACEBOOK_SIGN_IN_METHOD="facebook.com";es.PROVIDER_ID="facebook.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ts extends Bo{constructor(){super("github.com")}static credential(e){return Gs._fromParams({providerId:ts.PROVIDER_ID,signInMethod:ts.GITHUB_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return ts.credentialFromTaggedObject(e)}static credentialFromError(e){return ts.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return ts.credential(e.oauthAccessToken)}catch{return null}}}ts.GITHUB_SIGN_IN_METHOD="github.com";ts.PROVIDER_ID="github.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qs{constructor(e){this.user=e.user,this.providerId=e.providerId,this._tokenResponse=e._tokenResponse,this.operationType=e.operationType}static async _fromIdTokenResponse(e,n,s,i=!1){const r=await js._fromIdTokenResponse(e,s,i),o=Mg(s);return new Qs({user:r,providerId:o,_tokenResponse:s,operationType:n})}static async _forOperation(e,n,s){await e._updateTokensIfNecessary(s,!0);const i=Mg(s);return new Qs({user:e,providerId:i,_tokenResponse:s,operationType:n})}}function Mg(t){return t.providerId?t.providerId:"phoneNumber"in t?"phone":null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function bO(t,e,n=!1){const{auth:s}=t,i="reauthenticate";try{const r=await ho(t,Gw(s,i,e,t),n);G(r.idToken,s,"internal-error");const o=Gd(r.idToken);G(o,s,"internal-error");const{sub:a}=o;return G(t.uid===a,s,"user-mismatch"),Qs._forOperation(t,i,r)}catch(r){throw(r==null?void 0:r.code)==="auth/user-not-found"&&Yt(s,"user-mismatch"),r}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Qw(t,e,n=!1){const s="signIn",i=await Gw(t,s,e),r=await Qs._fromIdTokenResponse(t,s,i);return n||await t._updateCurrentUser(r.user),r}async function IO(t,e){return Qw(or(t),e)}async function CO(t,e,n){const s=or(t),i=await EO(s,{returnSecureToken:!0,email:e,password:n}),r=await Qs._fromIdTokenResponse(s,"signIn",i);return await s._updateCurrentUser(r.user),r}function SO(t,e,n){return IO($e(t),ar.credential(e,n))}function Yw(t,e,n,s){return $e(t).onIdTokenChanged(e,n,s)}function RO(t,e,n){return $e(t).beforeAuthStateChanged(e,n)}function Xw(t,e,n,s){return $e(t).onAuthStateChanged(e,n,s)}function AO(t){return $e(t).signOut()}const tc="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hD=new Map,dD={activated:!1,tokenObservers:[]};function An(t){return hD.get(t)||Object.assign({},dD)}const Wg={OFFSET_DURATION:5*60*1e3,RETRIAL_MIN_WAIT:30*1e3,RETRIAL_MAX_WAIT:16*60*1e3};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fD{constructor(e,n,s,i,r){if(this.operation=e,this.retryPolicy=n,this.getWaitDuration=s,this.lowerBound=i,this.upperBound=r,this.pending=null,this.nextErrorWaitInterval=i,i>r)throw new Error("Proactive refresh lower bound greater than upper bound!")}start(){this.nextErrorWaitInterval=this.lowerBound,this.process(!0).catch(()=>{})}stop(){this.pending&&(this.pending.reject("cancelled"),this.pending=null)}isRunning(){return!!this.pending}async process(e){this.stop();try{this.pending=new Xr,await pD(this.getNextRun(e)),this.pending.resolve(),await this.pending.promise,this.pending=new Xr,await this.operation(),this.pending.resolve(),await this.pending.promise,this.process(!0).catch(()=>{})}catch(n){this.retryPolicy(n)?this.process(!1).catch(()=>{}):this.stop()}}getNextRun(e){if(e)return this.nextErrorWaitInterval=this.lowerBound,this.getWaitDuration();{const n=this.nextErrorWaitInterval;return this.nextErrorWaitInterval*=2,this.nextErrorWaitInterval>this.upperBound&&(this.nextErrorWaitInterval=this.upperBound),n}}}function pD(t){return new Promise(e=>{setTimeout(e,t)})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gD={["already-initialized"]:"You have already called initializeAppCheck() for FirebaseApp {$appName} with different options. To avoid this error, call initializeAppCheck() with the same options as when it was originally called. This will return the already initialized instance.",["use-before-activation"]:"App Check is being used before initializeAppCheck() is called for FirebaseApp {$appName}. Call initializeAppCheck() before instantiating other Firebase services.",["fetch-network-error"]:"Fetch failed to connect to a network. Check Internet connection. Original error: {$originalErrorMessage}.",["fetch-parse-error"]:"Fetch client could not parse response. Original error: {$originalErrorMessage}.",["fetch-status-error"]:"Fetch server returned an HTTP error status. HTTP status: {$httpStatus}.",["storage-open"]:"Error thrown when opening storage. Original error: {$originalErrorMessage}.",["storage-get"]:"Error thrown when reading from storage. Original error: {$originalErrorMessage}.",["storage-set"]:"Error thrown when writing to storage. Original error: {$originalErrorMessage}.",["recaptcha-error"]:"ReCAPTCHA error.",throttled:"Requests throttled due to {$httpStatus} error. Attempts allowed again after {$time}"},sc=new Zi("appCheck","AppCheck",gD);function mD(t){if(!An(t).activated)throw sc.create("use-before-activation",{appName:t.name})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _D="firebase-app-check-database",yD=1,eh="firebase-app-check-store";let aa=null;function vD(){return aa||(aa=new Promise((t,e)=>{try{const n=indexedDB.open(_D,yD);n.onsuccess=s=>{t(s.target.result)},n.onerror=s=>{var i;e(sc.create("storage-open",{originalErrorMessage:(i=s.target.error)===null||i===void 0?void 0:i.message}))},n.onupgradeneeded=s=>{const i=s.target.result;switch(s.oldVersion){case 0:i.createObjectStore(eh,{keyPath:"compositeKey"})}}}catch(n){e(sc.create("storage-open",{originalErrorMessage:n==null?void 0:n.message}))}}),aa)}function wD(t,e){return ED(TD(t),e)}async function ED(t,e){const s=(await vD()).transaction(eh,"readwrite"),r=s.objectStore(eh).put({compositeKey:t,value:e});return new Promise((o,a)=>{r.onsuccess=c=>{o()},s.onerror=c=>{var l;a(sc.create("storage-set",{originalErrorMessage:(l=c.target.error)===null||l===void 0?void 0:l.message}))}})}function TD(t){return`${t.options.appId}-${t.name}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const th=new yo("@firebase/app-check");function Kg(t,e){return ay()?wD(t,e).catch(n=>{th.warn(`Failed to write token to IndexedDB. Error: ${n}`)}):Promise.resolve()}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bD={error:"UNKNOWN_ERROR"};function ID(t){return Ac.encodeString(JSON.stringify(t),!1)}async function nh(t,e=!1){const n=t.app;mD(n);const s=An(n);let i=s.token,r;if(i&&!Ar(i)&&(s.token=void 0,i=void 0),!i){const c=await s.cachedTokenPromise;c&&(Ar(c)?i=c:await Kg(n,void 0))}if(!e&&i&&Ar(i))return{token:i.token};let o=!1;try{s.exchangeTokenPromise||(s.exchangeTokenPromise=s.provider.getToken().finally(()=>{s.exchangeTokenPromise=void 0}),o=!0),i=await An(n).exchangeTokenPromise}catch(c){c.code==="appCheck/throttled"?th.warn(c.message):th.error(c),r=c}let a;return i?r?Ar(i)?a={token:i.token,internalError:r}:a=Gg(r):(a={token:i.token},s.token=i,await Kg(n,i)):a=Gg(r),o&&RD(n,a),a}function CD(t,e,n,s){const{app:i}=t,r=An(i),o={next:n,error:s,type:e};if(r.tokenObservers=[...r.tokenObservers,o],r.token&&Ar(r.token)){const a=r.token;Promise.resolve().then(()=>{n({token:a.token}),zg(t)}).catch(()=>{})}r.cachedTokenPromise.then(()=>zg(t))}function uE(t,e){const n=An(t),s=n.tokenObservers.filter(i=>i.next!==e);s.length===0&&n.tokenRefresher&&n.tokenRefresher.isRunning()&&n.tokenRefresher.stop(),n.tokenObservers=s}function zg(t){const{app:e}=t,n=An(e);let s=n.tokenRefresher;s||(s=SD(t),n.tokenRefresher=s),!s.isRunning()&&n.isTokenAutoRefreshEnabled&&s.start()}function SD(t){const{app:e}=t;return new fD(async()=>{const n=An(e);let s;if(n.token?s=await nh(t,!0):s=await nh(t),s.error)throw s.error;if(s.internalError)throw s.internalError},()=>!0,()=>{const n=An(e);if(n.token){let s=n.token.issuedAtTimeMillis+(n.token.expireTimeMillis-n.token.issuedAtTimeMillis)*.5+3e5;const i=n.token.expireTimeMillis-5*60*1e3;return s=Math.min(s,i),Math.max(0,s-Date.now())}else return 0},Wg.RETRIAL_MIN_WAIT,Wg.RETRIAL_MAX_WAIT)}function RD(t,e){const n=An(t).tokenObservers;for(const s of n)try{s.type==="EXTERNAL"&&e.error!=null?s.error(e.error):s.next(e)}catch{}}function Ar(t){return t.expireTimeMillis-Date.now()>0}function Gg(t){return{token:ID(bD),error:t}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class AD{constructor(e,n){this.app=e,this.heartbeatServiceProvider=n}_delete(){const{tokenObservers:e}=An(this.app);for(const n of e)uE(this.app,n.next);return Promise.resolve()}}function kD(t,e){return new AD(t,e)}function ND(t){return{getToken:e=>nh(t,e),addTokenListener:e=>CD(t,"INTERNAL",e),removeTokenListener:e=>uE(t.app,e)}}const OD="@firebase/app-check",DD="0.6.3",PD="app-check",Qg="app-check-internal";function xD(){Cn(new fn(PD,t=>{const e=t.getProvider("app").getImmediate(),n=t.getProvider("heartbeat");return kD(e,n)},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((t,e,n)=>{t.getProvider(Qg).initialize()})),Cn(new fn(Qg,t=>{const e=t.getProvider("app-check").getImmediate();return ND(e)},"PUBLIC").setInstantiationMode("EXPLICIT")),Vt(OD,DD)}xD();const hE=Symbol("firebaseApp");function pl(t){return Cc()&&Gt(hE,null)||Dc(t)}const Fn=()=>{};function nf(t,e){return e.split(".").reduce((n,s)=>n&&n[s],t)}function MD(t,e,n){const s=(""+e).split("."),i=s.pop(),r=s.reduce((o,a)=>o&&o[a],t);if(r!=null)return Array.isArray(r)?r.splice(Number(i),1,n):r[i]=n}function oi(t){return!!t&&typeof t=="object"}const LD=Object.prototype;function FD(t){return oi(t)&&Object.getPrototypeOf(t)===LD}function sf(t){return oi(t)&&t.type==="document"}function UD(t){return oi(t)&&t.type==="collection"}function BD(t){return sf(t)||UD(t)}function $D(t){return oi(t)&&t.type==="query"}function VD(t){return oi(t)&&"ref"in t}function jD(t){return oi(t)&&typeof t.bucket=="string"}function HD(t,e){let n;return()=>{if(!n)return n=!0,t(e())}}function qD(){return!!(Cc()&&Gt(U_,null))}const ca=new WeakMap;function WD(t,e){if(!ca.has(t)){const n=sb(!0);ca.set(t,n);const{unmount:s}=e;e.unmount=()=>{s.call(e),n.stop(),ca.delete(t)}}return ca.get(t)}const KD=new WeakMap,la=new WeakMap;function zD(t){const e=pl(t);if(!la.has(e)){let n;const i=[new Promise(r=>{n=r}),r=>{la.set(e,r),n(r.value)}];la.set(e,i)}return la.get(e)}function GD(t,e){const n=lE(e);Yw(n,s=>{const i=zD();t.value=s,Array.isArray(i)&&i[1](t)})}const Yg="@firebase/database",Xg="0.14.3";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class XD{constructor(){this.cache_={},this.isInMemoryStorage=!0}set(e,n){n==null?delete this.cache_[e]:this.cache_[e]=n}get(e){return Gn(this.cache_,e)?this.cache_[e]:null}remove(e){delete this.cache_[e]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fE=function(t){try{if(typeof window<"u"&&typeof window[t]<"u"){const e=window[t];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new YD(e)}}catch{}return new XD},Fs=fE("localStorage"),sh=fE("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ni=new yo("@firebase/database"),JD=function(){let t=1;return function(){return t++}}(),pE=function(t){const e=PC(t),n=new AC;n.update(e);const s=n.digest();return Ac.encodeByteArray(s)},Vo=function(...t){let e="";for(let n=0;n<t.length;n++){const s=t[n];Array.isArray(s)||s&&typeof s=="object"&&typeof s.length=="number"?e+=Vo.apply(null,s):typeof s=="object"?e+=ct(s):e+=s,e+=" "}return e};let Hs=null,Jg=!0;const ZD=function(t,e){x(!e||t===!0||t===!1,"Can't turn on custom loggers persistently."),t===!0?(Ni.logLevel=fe.VERBOSE,Hs=Ni.log.bind(Ni),e&&sh.set("logging_enabled",!0)):typeof t=="function"?Hs=t:(Hs=null,sh.remove("logging_enabled"))},gt=function(...t){if(Jg===!0&&(Jg=!1,Hs===null&&sh.get("logging_enabled")===!0&&ZD(!0)),Hs){const e=Vo.apply(null,t);Hs(e)}},jo=function(t){return function(...e){gt(t,...e)}},ih=function(...t){const e="FIREBASE INTERNAL ERROR: "+Vo(...t);Ni.error(e)},Ys=function(...t){const e=`FIREBASE FATAL ERROR: ${Vo(...t)}`;throw Ni.error(e),new Error(e)},jt=function(...t){const e="FIREBASE WARNING: "+Vo(...t);Ni.warn(e)},eP=function(){typeof window<"u"&&window.location&&window.location.protocol&&window.location.protocol.indexOf("https:")!==-1&&jt("Insecure Firebase access from a secure page. Please use https in calls to new Firebase().")},gE=function(t){return typeof t=="number"&&(t!==t||t===Number.POSITIVE_INFINITY||t===Number.NEGATIVE_INFINITY)},tP=function(t){if(document.readyState==="complete")t();else{let e=!1;const n=function(){if(!document.body){setTimeout(n,Math.floor(10));return}e||(e=!0,t())};document.addEventListener?(document.addEventListener("DOMContentLoaded",n,!1),window.addEventListener("load",n,!1)):document.attachEvent&&(document.attachEvent("onreadystatechange",()=>{document.readyState==="complete"&&n()}),window.attachEvent("onload",n))}},Ki="[MIN_NAME]",Xs="[MAX_NAME]",cr=function(t,e){if(t===e)return 0;if(t===Ki||e===Xs)return-1;if(e===Ki||t===Xs)return 1;{const n=Zg(t),s=Zg(e);return n!==null?s!==null?n-s===0?t.length-e.length:n-s:-1:s!==null?1:t<e?-1:1}},nP=function(t,e){return t===e?0:t<e?-1:1},mr=function(t,e){if(e&&t in e)return e[t];throw new Error("Missing required key ("+t+") in object: "+ct(e))},rf=function(t){if(typeof t!="object"||t===null)return ct(t);const e=[];for(const s in t)e.push(s);e.sort();let n="{";for(let s=0;s<e.length;s++)s!==0&&(n+=","),n+=ct(e[s]),n+=":",n+=rf(t[e[s]]);return n+="}",n},mE=function(t,e){const n=t.length;if(n<=e)return[t];const s=[];for(let i=0;i<n;i+=e)i+e>n?s.push(t.substring(i,n)):s.push(t.substring(i,i+e));return s};function Xt(t,e){for(const n in t)t.hasOwnProperty(n)&&e(n,t[n])}const _E=function(t){x(!gE(t),"Invalid JSON number");const e=11,n=52,s=(1<<e-1)-1;let i,r,o,a,c;t===0?(r=0,o=0,i=1/t===-1/0?1:0):(i=t<0,t=Math.abs(t),t>=Math.pow(2,1-s)?(a=Math.min(Math.floor(Math.log(t)/Math.LN2),s),r=a+s,o=Math.round(t*Math.pow(2,n-a)-Math.pow(2,n))):(r=0,o=Math.round(t/Math.pow(2,1-s-n))));const l=[];for(c=n;c;c-=1)l.push(o%2?1:0),o=Math.floor(o/2);for(c=e;c;c-=1)l.push(r%2?1:0),r=Math.floor(r/2);l.push(i?1:0),l.reverse();const u=l.join("");let h="";for(c=0;c<64;c+=8){let d=parseInt(u.substr(c,8),2).toString(16);d.length===1&&(d="0"+d),h=h+d}return h.toLowerCase()},sP=function(){return!!(typeof window=="object"&&window.chrome&&window.chrome.extension&&!/^chrome/.test(window.location.href))},iP=function(){return typeof Windows=="object"&&typeof Windows.UI=="object"},rP=new RegExp("^-?(0*)\\d{1,10}$"),oP=-2147483648,aP=2147483647,Zg=function(t){if(rP.test(t)){const e=Number(t);if(e>=oP&&e<=aP)return e}return null},Ho=function(t){try{t()}catch(e){setTimeout(()=>{const n=e.stack||"";throw jt("Exception was thrown by user callback.",n),e},Math.floor(0))}},cP=function(){return(typeof window=="object"&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0},$r=function(t,e){const n=setTimeout(t,e);return typeof n=="number"&&typeof Deno<"u"&&Deno.unrefTimer?Deno.unrefTimer(n):typeof n=="object"&&n.unref&&n.unref(),n};/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lP{constructor(e,n){this.appName_=e,this.appCheckProvider=n,this.appCheck=n==null?void 0:n.getImmediate({optional:!0}),this.appCheck||n==null||n.get().then(s=>this.appCheck=s)}getToken(e){return this.appCheck?this.appCheck.getToken(e):new Promise((n,s)=>{setTimeout(()=>{this.appCheck?this.getToken(e).then(n,s):n(null)},0)})}addTokenChangeListener(e){var n;(n=this.appCheckProvider)===null||n===void 0||n.get().then(s=>s.addTokenListener(e))}notifyForInvalidToken(){jt(`Provided AppCheck credentials for the app named "${this.appName_}" are invalid. This usually indicates your app was not initialized correctly.`)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class uP{constructor(e,n,s){this.appName_=e,this.firebaseOptions_=n,this.authProvider_=s,this.auth_=null,this.auth_=s.getImmediate({optional:!0}),this.auth_||s.onInit(i=>this.auth_=i)}getToken(e){return this.auth_?this.auth_.getToken(e).catch(n=>n&&n.code==="auth/token-not-initialized"?(gt("Got auth/token-not-initialized error.  Treating as null token."),null):Promise.reject(n)):new Promise((n,s)=>{setTimeout(()=>{this.auth_?this.getToken(e).then(n,s):n(null)},0)})}addTokenChangeListener(e){this.auth_?this.auth_.addAuthTokenListener(e):this.authProvider_.get().then(n=>n.addAuthTokenListener(e))}removeTokenChangeListener(e){this.authProvider_.get().then(n=>n.removeAuthTokenListener(e))}notifyForInvalidToken(){let e='Provided authentication credentials for the app named "'+this.appName_+'" are invalid. This usually indicates your app was not initialized correctly. ';"credential"in this.firebaseOptions_?e+='Make sure the "credential" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':"serviceAccount"in this.firebaseOptions_?e+='Make sure the "serviceAccount" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':e+='Make sure the "apiKey" and "databaseURL" properties provided to initializeApp() match the values provided for your app at https://console.firebase.google.com/.',jt(e)}}class rh{constructor(e){this.accessToken=e}getToken(e){return Promise.resolve({accessToken:this.accessToken})}addTokenChangeListener(e){e(this.accessToken)}removeTokenChangeListener(e){}notifyForInvalidToken(){}}rh.OWNER="owner";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const of="5",yE="v",vE="s",wE="r",EE="f",TE=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,bE="ls",IE="p",oh="ac",CE="websocket",SE="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hP{constructor(e,n,s,i,r=!1,o="",a=!1,c=!1){this.secure=n,this.namespace=s,this.webSocketOnly=i,this.nodeAdmin=r,this.persistenceKey=o,this.includeNamespaceInQueryParams=a,this.isUsingEmulator=c,this._host=e.toLowerCase(),this._domain=this._host.substr(this._host.indexOf(".")+1),this.internalHost=Fs.get("host:"+e)||this._host}isCacheableHost(){return this.internalHost.substr(0,2)==="s-"}isCustomHost(){return this._domain!=="firebaseio.com"&&this._domain!=="firebaseio-demo.com"}get host(){return this._host}set host(e){e!==this.internalHost&&(this.internalHost=e,this.isCacheableHost()&&Fs.set("host:"+this._host,this.internalHost))}toString(){let e=this.toURLString();return this.persistenceKey&&(e+="<"+this.persistenceKey+">"),e}toURLString(){const e=this.secure?"https://":"http://",n=this.includeNamespaceInQueryParams?`?ns=${this.namespace}`:"";return`${e}${this.host}/${n}`}}function dP(t){return t.host!==t.internalHost||t.isCustomHost()||t.includeNamespaceInQueryParams}function RE(t,e,n){x(typeof e=="string","typeof type must == string"),x(typeof n=="object","typeof params must == object");let s;if(e===CE)s=(t.secure?"wss://":"ws://")+t.internalHost+"/.ws?";else if(e===SE)s=(t.secure?"https://":"http://")+t.internalHost+"/.lp?";else throw new Error("Unknown connection type: "+e);dP(t)&&(n.ns=t.namespace);const i=[];return Xt(n,(r,o)=>{i.push(r+"="+o)}),s+i.join("&")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fP{constructor(){this.counters_={}}incrementCounter(e,n=1){Gn(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=n}get(){return dC(this.counters_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zl={},Gl={};function af(t){const e=t.toString();return zl[e]||(zl[e]=new fP),zl[e]}function pP(t,e){const n=t.toString();return Gl[n]||(Gl[n]=e()),Gl[n]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const em="start",mP="close",_P="pLPCommand",yP="pRTLPCB",AE="id",kE="pw",NE="ser",vP="cb",wP="seg",EP="ts",TP="d",bP="dframe",OE=1870,DE=30,IP=OE-DE,CP=25e3,SP=3e4;class vi{constructor(e,n,s,i,r,o,a){this.connId=e,this.repoInfo=n,this.applicationId=s,this.appCheckToken=i,this.authToken=r,this.transportSessionId=o,this.lastSessionId=a,this.bytesSent=0,this.bytesReceived=0,this.everConnected_=!1,this.log_=jo(e),this.stats_=af(n),this.urlFn=c=>(this.appCheckToken&&(c[oh]=this.appCheckToken),RE(n,SE,c))}open(e,n){this.curSegmentNum=0,this.onDisconnect_=n,this.myPacketOrderer=new gP(e),this.isClosed_=!1,this.connectTimeoutTimer_=setTimeout(()=>{this.log_("Timed out trying to connect."),this.onClosed_(),this.connectTimeoutTimer_=null},Math.floor(SP)),tP(()=>{if(this.isClosed_)return;this.scriptTagHolder=new cf((...r)=>{const[o,a,c,l,u]=r;if(this.incrementIncomingBytes_(r),!!this.scriptTagHolder)if(this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null),this.everConnected_=!0,o===em)this.id=a,this.password=c;else if(o===mP)a?(this.scriptTagHolder.sendNewPolls=!1,this.myPacketOrderer.closeAfter(a,()=>{this.onClosed_()})):this.onClosed_();else throw new Error("Unrecognized command received: "+o)},(...r)=>{const[o,a]=r;this.incrementIncomingBytes_(r),this.myPacketOrderer.handleResponse(o,a)},()=>{this.onClosed_()},this.urlFn);const s={};s[em]="t",s[NE]=Math.floor(Math.random()*1e8),this.scriptTagHolder.uniqueCallbackIdentifier&&(s[vP]=this.scriptTagHolder.uniqueCallbackIdentifier),s[yE]=of,this.transportSessionId&&(s[vE]=this.transportSessionId),this.lastSessionId&&(s[bE]=this.lastSessionId),this.applicationId&&(s[IE]=this.applicationId),this.appCheckToken&&(s[oh]=this.appCheckToken),typeof location<"u"&&location.hostname&&TE.test(location.hostname)&&(s[wE]=EE);const i=this.urlFn(s);this.log_("Connecting via long-poll to "+i),this.scriptTagHolder.addTag(i,()=>{})})}start(){this.scriptTagHolder.startLongPoll(this.id,this.password),this.addDisconnectPingFrame(this.id,this.password)}static forceAllow(){vi.forceAllow_=!0}static forceDisallow(){vi.forceDisallow_=!0}static isAvailable(){return vi.forceAllow_?!0:!vi.forceDisallow_&&typeof document<"u"&&document.createElement!=null&&!sP()&&!iP()}markConnectionHealthy(){}shutdown_(){this.isClosed_=!0,this.scriptTagHolder&&(this.scriptTagHolder.close(),this.scriptTagHolder=null),this.myDisconnFrame&&(document.body.removeChild(this.myDisconnFrame),this.myDisconnFrame=null),this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null)}onClosed_(){this.isClosed_||(this.log_("Longpoll is closing itself"),this.shutdown_(),this.onDisconnect_&&(this.onDisconnect_(this.everConnected_),this.onDisconnect_=null))}close(){this.isClosed_||(this.log_("Longpoll is being closed."),this.shutdown_())}send(e){const n=ct(e);this.bytesSent+=n.length,this.stats_.incrementCounter("bytes_sent",n.length);const s=Z_(n),i=mE(s,IP);for(let r=0;r<i.length;r++)this.scriptTagHolder.enqueueSegment(this.curSegmentNum,i.length,i[r]),this.curSegmentNum++}addDisconnectPingFrame(e,n){this.myDisconnFrame=document.createElement("iframe");const s={};s[bP]="t",s[AE]=e,s[kE]=n,this.myDisconnFrame.src=this.urlFn(s),this.myDisconnFrame.style.display="none",document.body.appendChild(this.myDisconnFrame)}incrementIncomingBytes_(e){const n=ct(e).length;this.bytesReceived+=n,this.stats_.incrementCounter("bytes_received",n)}}class cf{constructor(e,n,s,i){this.onDisconnect=s,this.urlFn=i,this.outstandingRequests=new Set,this.pendingSegs=[],this.currentSerial=Math.floor(Math.random()*1e8),this.sendNewPolls=!0;{this.uniqueCallbackIdentifier=JD(),window[_P+this.uniqueCallbackIdentifier]=e,window[yP+this.uniqueCallbackIdentifier]=n,this.myIFrame=cf.createIFrame_();let r="";this.myIFrame.src&&this.myIFrame.src.substr(0,11)==="javascript:"&&(r='<script>document.domain="'+document.domain+'";<\/script>');const o="<html><body>"+r+"</body></html>";try{this.myIFrame.doc.open(),this.myIFrame.doc.write(o),this.myIFrame.doc.close()}catch(a){gt("frame writing exception"),a.stack&&gt(a.stack),gt(a)}}}static createIFrame_(){const e=document.createElement("iframe");if(e.style.display="none",document.body){document.body.appendChild(e);try{e.contentWindow.document||gt("No IE domain setting required")}catch{const s=document.domain;e.src="javascript:void((function(){document.open();document.domain='"+s+"';document.close();})())"}}else throw"Document body has not initialized. Wait to initialize Firebase until after the document is ready.";return e.contentDocument?e.doc=e.contentDocument:e.contentWindow?e.doc=e.contentWindow.document:e.document&&(e.doc=e.document),e}close(){this.alive=!1,this.myIFrame&&(this.myIFrame.doc.body.textContent="",setTimeout(()=>{this.myIFrame!==null&&(document.body.removeChild(this.myIFrame),this.myIFrame=null)},Math.floor(0)));const e=this.onDisconnect;e&&(this.onDisconnect=null,e())}startLongPoll(e,n){for(this.myID=e,this.myPW=n,this.alive=!0;this.newRequest_(););}newRequest_(){if(this.alive&&this.sendNewPolls&&this.outstandingRequests.size<(this.pendingSegs.length>0?2:1)){this.currentSerial++;const e={};e[AE]=this.myID,e[kE]=this.myPW,e[NE]=this.currentSerial;let n=this.urlFn(e),s="",i=0;for(;this.pendingSegs.length>0&&this.pendingSegs[0].d.length+DE+s.length<=OE;){const o=this.pendingSegs.shift();s=s+"&"+wP+i+"="+o.seg+"&"+EP+i+"="+o.ts+"&"+TP+i+"="+o.d,i++}return n=n+s,this.addLongPollTag_(n,this.currentSerial),!0}else return!1}enqueueSegment(e,n,s){this.pendingSegs.push({seg:e,ts:n,d:s}),this.alive&&this.newRequest_()}addLongPollTag_(e,n){this.outstandingRequests.add(n);const s=()=>{this.outstandingRequests.delete(n),this.newRequest_()},i=setTimeout(s,Math.floor(CP)),r=()=>{clearTimeout(i),s()};this.addTag(e,r)}addTag(e,n){setTimeout(()=>{try{if(!this.sendNewPolls)return;const s=this.myIFrame.doc.createElement("script");s.type="text/javascript",s.async=!0,s.src=e,s.onload=s.onreadystatechange=function(){const i=s.readyState;(!i||i==="loaded"||i==="complete")&&(s.onload=s.onreadystatechange=null,s.parentNode&&s.parentNode.removeChild(s),n())},s.onerror=()=>{gt("Long-poll script failed to load: "+e),this.sendNewPolls=!1,this.close()},this.myIFrame.doc.body.appendChild(s)}catch{}},Math.floor(1))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const RP=16384,AP=45e3;let ic=null;typeof MozWebSocket<"u"?ic=MozWebSocket:typeof WebSocket<"u"&&(ic=WebSocket);class rn{constructor(e,n,s,i,r,o,a){this.connId=e,this.applicationId=s,this.appCheckToken=i,this.authToken=r,this.keepaliveTimer=null,this.frames=null,this.totalFrames=0,this.bytesSent=0,this.bytesReceived=0,this.log_=jo(this.connId),this.stats_=af(n),this.connURL=rn.connectionURL_(n,o,a,i,s),this.nodeAdmin=n.nodeAdmin}static connectionURL_(e,n,s,i,r){const o={};return o[yE]=of,typeof location<"u"&&location.hostname&&TE.test(location.hostname)&&(o[wE]=EE),n&&(o[vE]=n),s&&(o[bE]=s),i&&(o[oh]=i),r&&(o[IE]=r),RE(e,CE,o)}open(e,n){this.onDisconnect=n,this.onMessage=e,this.log_("Websocket connecting to "+this.connURL),this.everConnected_=!1,Fs.set("previous_websocket_failure",!0);try{let s;oy(),this.mySock=new ic(this.connURL,[],s)}catch(s){this.log_("Error instantiating WebSocket.");const i=s.message||s.data;i&&this.log_(i),this.onClosed_();return}this.mySock.onopen=()=>{this.log_("Websocket connected."),this.everConnected_=!0},this.mySock.onclose=()=>{this.log_("Websocket connection was disconnected."),this.mySock=null,this.onClosed_()},this.mySock.onmessage=s=>{this.handleIncomingFrame(s)},this.mySock.onerror=s=>{this.log_("WebSocket error.  Closing connection.");const i=s.message||s.data;i&&this.log_(i),this.onClosed_()}}start(){}static forceDisallow(){rn.forceDisallow_=!0}static isAvailable(){let e=!1;if(typeof navigator<"u"&&navigator.userAgent){const n=/Android ([0-9]{0,}\.[0-9]{0,})/,s=navigator.userAgent.match(n);s&&s.length>1&&parseFloat(s[1])<4.4&&(e=!0)}return!e&&ic!==null&&!rn.forceDisallow_}static previouslyFailed(){return Fs.isInMemoryStorage||Fs.get("previous_websocket_failure")===!0}markConnectionHealthy(){Fs.remove("previous_websocket_failure")}appendFrame_(e){if(this.frames.push(e),this.frames.length===this.totalFrames){const n=this.frames.join("");this.frames=null;const s=Jr(n);this.onMessage(s)}}handleNewFrameCount_(e){this.totalFrames=e,this.frames=[]}extractFrameCount_(e){if(x(this.frames===null,"We already have a frame buffer"),e.length<=6){const n=Number(e);if(!isNaN(n))return this.handleNewFrameCount_(n),null}return this.handleNewFrameCount_(1),e}handleIncomingFrame(e){if(this.mySock===null)return;const n=e.data;if(this.bytesReceived+=n.length,this.stats_.incrementCounter("bytes_received",n.length),this.resetKeepAlive(),this.frames!==null)this.appendFrame_(n);else{const s=this.extractFrameCount_(n);s!==null&&this.appendFrame_(s)}}send(e){this.resetKeepAlive();const n=ct(e);this.bytesSent+=n.length,this.stats_.incrementCounter("bytes_sent",n.length);const s=mE(n,RP);s.length>1&&this.sendString_(String(s.length));for(let i=0;i<s.length;i++)this.sendString_(s[i])}shutdown_(){this.isClosed_=!0,this.keepaliveTimer&&(clearInterval(this.keepaliveTimer),this.keepaliveTimer=null),this.mySock&&(this.mySock.close(),this.mySock=null)}onClosed_(){this.isClosed_||(this.log_("WebSocket is closing itself"),this.shutdown_(),this.onDisconnect&&(this.onDisconnect(this.everConnected_),this.onDisconnect=null))}close(){this.isClosed_||(this.log_("WebSocket is being closed"),this.shutdown_())}resetKeepAlive(){clearInterval(this.keepaliveTimer),this.keepaliveTimer=setInterval(()=>{this.mySock&&this.sendString_("0"),this.resetKeepAlive()},Math.floor(AP))}sendString_(e){try{this.mySock.send(e)}catch(n){this.log_("Exception thrown from WebSocket.send():",n.message||n.data,"Closing connection."),setTimeout(this.onClosed_.bind(this),0)}}}rn.responsesRequiredToBeHealthy=2;rn.healthyTimeout=3e4;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kP=6e4,NP=5e3,OP=10*1024,DP=100*1024,Ql="t",tm="d",PP="s",nm="r",xP="e",sm="o",im="a",rm="n",om="p",MP="h";class LP{constructor(e,n,s,i,r,o,a,c,l,u){this.id=e,this.repoInfo_=n,this.applicationId_=s,this.appCheckToken_=i,this.authToken_=r,this.onMessage_=o,this.onReady_=a,this.onDisconnect_=c,this.onKill_=l,this.lastSessionId=u,this.connectionCount=0,this.pendingDataMessages=[],this.state_=0,this.log_=jo("c:"+this.id+":"),this.transportManager_=new go(n),this.log_("Connection created"),this.start_()}start_(){const e=this.transportManager_.initialTransport();this.conn_=new e(this.nextTransportId_(),this.repoInfo_,this.applicationId_,this.appCheckToken_,this.authToken_,null,this.lastSessionId),this.primaryResponsesRequired_=e.responsesRequiredToBeHealthy||0;const n=this.connReceiver_(this.conn_),s=this.disconnReceiver_(this.conn_);this.tx_=this.conn_,this.rx_=this.conn_,this.secondaryConn_=null,this.isHealthy_=!1,setTimeout(()=>{this.conn_&&this.conn_.open(n,s)},Math.floor(0));const i=e.healthyTimeout||0;i>0&&(this.healthyTimeout_=$r(()=>{this.healthyTimeout_=null,this.isHealthy_||(this.conn_&&this.conn_.bytesReceived>DP?(this.log_("Connection exceeded healthy timeout but has received "+this.conn_.bytesReceived+" bytes.  Marking connection healthy."),this.isHealthy_=!0,this.conn_.markConnectionHealthy()):this.conn_&&this.conn_.bytesSent>OP?this.log_("Connection exceeded healthy timeout but has sent "+this.conn_.bytesSent+" bytes.  Leaving connection alive."):(this.log_("Closing unhealthy connection after timeout."),this.close()))},Math.floor(i)))}nextTransportId_(){return"c:"+this.id+":"+this.connectionCount++}disconnReceiver_(e){return n=>{e===this.conn_?this.onConnectionLost_(n):e===this.secondaryConn_?(this.log_("Secondary connection lost."),this.onSecondaryConnectionLost_()):this.log_("closing an old connection")}}connReceiver_(e){return n=>{this.state_!==2&&(e===this.rx_?this.onPrimaryMessageReceived_(n):e===this.secondaryConn_?this.onSecondaryMessageReceived_(n):this.log_("message on old connection"))}}sendRequest(e){const n={t:"d",d:e};this.sendData_(n)}tryCleanupConnection(){this.tx_===this.secondaryConn_&&this.rx_===this.secondaryConn_&&(this.log_("cleaning up and promoting a connection: "+this.secondaryConn_.connId),this.conn_=this.secondaryConn_,this.secondaryConn_=null)}onSecondaryControl_(e){if(Ql in e){const n=e[Ql];n===im?this.upgradeIfSecondaryHealthy_():n===nm?(this.log_("Got a reset on secondary, closing it"),this.secondaryConn_.close(),(this.tx_===this.secondaryConn_||this.rx_===this.secondaryConn_)&&this.close()):n===sm&&(this.log_("got pong on secondary."),this.secondaryResponsesRequired_--,this.upgradeIfSecondaryHealthy_())}}onSecondaryMessageReceived_(e){const n=mr("t",e),s=mr("d",e);if(n==="c")this.onSecondaryControl_(s);else if(n==="d")this.pendingDataMessages.push(s);else throw new Error("Unknown protocol layer: "+n)}upgradeIfSecondaryHealthy_(){this.secondaryResponsesRequired_<=0?(this.log_("Secondary connection is healthy."),this.isHealthy_=!0,this.secondaryConn_.markConnectionHealthy(),this.proceedWithUpgrade_()):(this.log_("sending ping on secondary."),this.secondaryConn_.send({t:"c",d:{t:om,d:{}}}))}proceedWithUpgrade_(){this.secondaryConn_.start(),this.log_("sending client ack on secondary"),this.secondaryConn_.send({t:"c",d:{t:im,d:{}}}),this.log_("Ending transmission on primary"),this.conn_.send({t:"c",d:{t:rm,d:{}}}),this.tx_=this.secondaryConn_,this.tryCleanupConnection()}onPrimaryMessageReceived_(e){const n=mr("t",e),s=mr("d",e);n==="c"?this.onControl_(s):n==="d"&&this.onDataMessage_(s)}onDataMessage_(e){this.onPrimaryResponse_(),this.onMessage_(e)}onPrimaryResponse_(){this.isHealthy_||(this.primaryResponsesRequired_--,this.primaryResponsesRequired_<=0&&(this.log_("Primary connection is healthy."),this.isHealthy_=!0,this.conn_.markConnectionHealthy()))}onControl_(e){const n=mr(Ql,e);if(tm in e){const s=e[tm];if(n===MP){const i=Object.assign({},s);this.repoInfo_.isUsingEmulator&&(i.h=this.repoInfo_.host),this.onHandshake_(i)}else if(n===rm){this.log_("recvd end transmission on primary"),this.rx_=this.secondaryConn_;for(let i=0;i<this.pendingDataMessages.length;++i)this.onDataMessage_(this.pendingDataMessages[i]);this.pendingDataMessages=[],this.tryCleanupConnection()}else n===PP?this.onConnectionShutdown_(s):n===nm?this.onReset_(s):n===xP?ih("Server Error: "+s):n===sm?(this.log_("got pong on primary."),this.onPrimaryResponse_(),this.sendPingOnPrimaryIfNecessary_()):ih("Unknown control packet command: "+n)}}onHandshake_(e){const n=e.ts,s=e.v,i=e.h;this.sessionId=e.s,this.repoInfo_.host=i,this.state_===0&&(this.conn_.start(),this.onConnectionEstablished_(this.conn_,n),of!==s&&jt("Protocol version mismatch detected"),this.tryStartUpgrade_())}tryStartUpgrade_(){const e=this.transportManager_.upgradeTransport();e&&this.startUpgrade_(e)}startUpgrade_(e){this.secondaryConn_=new e(this.nextTransportId_(),this.repoInfo_,this.applicationId_,this.appCheckToken_,this.authToken_,this.sessionId),this.secondaryResponsesRequired_=e.responsesRequiredToBeHealthy||0;const n=this.connReceiver_(this.secondaryConn_),s=this.disconnReceiver_(this.secondaryConn_);this.secondaryConn_.open(n,s),$r(()=>{this.secondaryConn_&&(this.log_("Timed out trying to upgrade."),this.secondaryConn_.close())},Math.floor(kP))}onReset_(e){this.log_("Reset packet received.  New host: "+e),this.repoInfo_.host=e,this.state_===1?this.close():(this.closeConnections_(),this.start_())}onConnectionEstablished_(e,n){this.log_("Realtime connection established."),this.conn_=e,this.state_=1,this.onReady_&&(this.onReady_(n,this.sessionId),this.onReady_=null),this.primaryResponsesRequired_===0?(this.log_("Primary connection is healthy."),this.isHealthy_=!0):$r(()=>{this.sendPingOnPrimaryIfNecessary_()},Math.floor(NP))}sendPingOnPrimaryIfNecessary_(){!this.isHealthy_&&this.state_===1&&(this.log_("sending ping on primary."),this.sendData_({t:"c",d:{t:om,d:{}}}))}onSecondaryConnectionLost_(){const e=this.secondaryConn_;this.secondaryConn_=null,(this.tx_===e||this.rx_===e)&&this.close()}onConnectionLost_(e){this.conn_=null,!e&&this.state_===0?(this.log_("Realtime connection failed."),this.repoInfo_.isCacheableHost()&&(Fs.remove("host:"+this.repoInfo_.host),this.repoInfo_.internalHost=this.repoInfo_.host)):this.state_===1&&this.log_("Realtime connection lost."),this.close()}onConnectionShutdown_(e){this.log_("Connection shutdown command received. Shutting down..."),this.onKill_&&(this.onKill_(e),this.onKill_=null),this.onDisconnect_=null,this.close()}sendData_(e){if(this.state_!==1)throw"Connection is not connected";this.tx_.send(e)}close(){this.state_!==2&&(this.log_("Closing realtime connection."),this.state_=2,this.closeConnections_(),this.onDisconnect_&&(this.onDisconnect_(),this.onDisconnect_=null))}closeConnections_(){this.log_("Shutting down all connections"),this.conn_&&(this.conn_.close(),this.conn_=null),this.secondaryConn_&&(this.secondaryConn_.close(),this.secondaryConn_=null),this.healthyTimeout_&&(clearTimeout(this.healthyTimeout_),this.healthyTimeout_=null)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class PE{put(e,n,s,i){}merge(e,n,s,i){}refreshAuthToken(e){}refreshAppCheckToken(e){}onDisconnectPut(e,n,s){}onDisconnectMerge(e,n,s){}onDisconnectCancel(e,n){}reportStats(e){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xE{constructor(e){this.allowedEvents_=e,this.listeners_={},x(Array.isArray(e)&&e.length>0,"Requires a non-empty array")}trigger(e,...n){if(Array.isArray(this.listeners_[e])){const s=[...this.listeners_[e]];for(let i=0;i<s.length;i++)s[i].callback.apply(s[i].context,n)}}on(e,n,s){this.validateEventType_(e),this.listeners_[e]=this.listeners_[e]||[],this.listeners_[e].push({callback:n,context:s});const i=this.getInitialEvent(e);i&&n.apply(s,i)}off(e,n,s){this.validateEventType_(e);const i=this.listeners_[e]||[];for(let r=0;r<i.length;r++)if(i[r].callback===n&&(!s||s===i[r].context)){i.splice(r,1);return}}validateEventType_(e){x(this.allowedEvents_.find(n=>n===e),"Unknown event: "+e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rc extends xE{constructor(){super(["online"]),this.online_=!0,typeof window<"u"&&typeof window.addEventListener<"u"&&!Wh()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}static getInstance(){return new rc}getInitialEvent(e){return x(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const am=32,cm=768;class xe{constructor(e,n){if(n===void 0){this.pieces_=e.split("/");let s=0;for(let i=0;i<this.pieces_.length;i++)this.pieces_[i].length>0&&(this.pieces_[s]=this.pieces_[i],s++);this.pieces_.length=s,this.pieceNum_=0}else this.pieces_=e,this.pieceNum_=n}toString(){let e="";for(let n=this.pieceNum_;n<this.pieces_.length;n++)this.pieces_[n]!==""&&(e+="/"+this.pieces_[n]);return e||"/"}}function Ie(){return new xe("")}function le(t){return t.pieceNum_>=t.pieces_.length?null:t.pieces_[t.pieceNum_]}function _s(t){return t.pieces_.length-t.pieceNum_}function De(t){let e=t.pieceNum_;return e<t.pieces_.length&&e++,new xe(t.pieces_,e)}function ME(t){return t.pieceNum_<t.pieces_.length?t.pieces_[t.pieces_.length-1]:null}function FP(t){let e="";for(let n=t.pieceNum_;n<t.pieces_.length;n++)t.pieces_[n]!==""&&(e+="/"+encodeURIComponent(String(t.pieces_[n])));return e||"/"}function LE(t,e=0){return t.pieces_.slice(t.pieceNum_+e)}function FE(t){if(t.pieceNum_>=t.pieces_.length)return null;const e=[];for(let n=t.pieceNum_;n<t.pieces_.length-1;n++)e.push(t.pieces_[n]);return new xe(e,0)}function rt(t,e){const n=[];for(let s=t.pieceNum_;s<t.pieces_.length;s++)n.push(t.pieces_[s]);if(e instanceof xe)for(let s=e.pieceNum_;s<e.pieces_.length;s++)n.push(e.pieces_[s]);else{const s=e.split("/");for(let i=0;i<s.length;i++)s[i].length>0&&n.push(s[i])}return new xe(n,0)}function ae(t){return t.pieceNum_>=t.pieces_.length}function Kt(t,e){const n=le(t),s=le(e);if(n===null)return e;if(n===s)return Kt(De(t),De(e));throw new Error("INTERNAL ERROR: innerPath ("+e+") is not within outerPath ("+t+")")}function UE(t,e){if(_s(t)!==_s(e))return!1;for(let n=t.pieceNum_,s=e.pieceNum_;n<=t.pieces_.length;n++,s++)if(t.pieces_[n]!==e.pieces_[s])return!1;return!0}function an(t,e){let n=t.pieceNum_,s=e.pieceNum_;if(_s(t)>_s(e))return!1;for(;n<t.pieces_.length;){if(t.pieces_[n]!==e.pieces_[s])return!1;++n,++s}return!0}class UP{constructor(e,n){this.errorPrefix_=n,this.parts_=LE(e,0),this.byteLength_=Math.max(1,this.parts_.length);for(let s=0;s<this.parts_.length;s++)this.byteLength_+=Nc(this.parts_[s]);BE(this)}}function BP(t,e){t.parts_.length>0&&(t.byteLength_+=1),t.parts_.push(e),t.byteLength_+=Nc(e),BE(t)}function $P(t){const e=t.parts_.pop();t.byteLength_-=Nc(e),t.parts_.length>0&&(t.byteLength_-=1)}function BE(t){if(t.byteLength_>cm)throw new Error(t.errorPrefix_+"has a key path longer than "+cm+" bytes ("+t.byteLength_+").");if(t.parts_.length>am)throw new Error(t.errorPrefix_+"path specified exceeds the maximum depth that can be written ("+am+") or object contains a cycle "+As(t))}function As(t){return t.parts_.length===0?"":"in property '"+t.parts_.join(".")+"'"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lf extends xE{constructor(){super(["visible"]);let e,n;typeof document<"u"&&typeof document.addEventListener<"u"&&(typeof document.hidden<"u"?(n="visibilitychange",e="hidden"):typeof document.mozHidden<"u"?(n="mozvisibilitychange",e="mozHidden"):typeof document.msHidden<"u"?(n="msvisibilitychange",e="msHidden"):typeof document.webkitHidden<"u"&&(n="webkitvisibilitychange",e="webkitHidden")),this.visible_=!0,n&&document.addEventListener(n,()=>{const s=!document[e];s!==this.visible_&&(this.visible_=s,this.trigger("visible",s))},!1)}static getInstance(){return new lf}getInitialEvent(e){return x(e==="visible","Unknown event type: "+e),[this.visible_]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function KP(t,e){return cr(t.name,e.name)}function uf(t,e){return cr(t,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ah;function zP(t){ah=t}const VE=function(t){return typeof t=="number"?"number:"+_E(t):"string:"+t},jE=function(t){if(t.isLeafNode()){const e=t.val();x(typeof e=="string"||typeof e=="number"||typeof e=="object"&&Gn(e,".sv"),"Priority must be a string or number.")}else x(t===ah||t.isEmpty(),"priority of unexpected type.");x(t===ah||t.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let HE,qE;function GP(t){HE=t}function QP(t){qE=t}class YP extends gl{compare(e,n){const s=e.node.getPriority(),i=n.node.getPriority(),r=s.compareTo(i);return r===0?cr(e.name,n.name):r}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,n){return!e.getPriority().equals(n.getPriority())}minPost(){return ue.MIN}maxPost(){return new ue(Xs,new nt("[PRIORITY-POST]",qE))}makePost(e,n){const s=HE(e);return new ue(n,new nt("[PRIORITY-POST]",s))}toString(){return".priority"}}const vt=new YP;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const XP=Math.log(2);class JP{constructor(e){const n=r=>parseInt(Math.log(r)/XP,10),s=r=>parseInt(Array(r+1).join("1"),2);this.count=n(e+1),this.current_=this.count-1;const i=s(this.count);this.bits_=e+1&i}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const oc=function(t,e,n,s){t.sort(e);const i=function(c,l){const u=l-c;let h,d;if(u===0)return null;if(u===1)return h=t[c],d=n?n(h):h,new it(d,h.node,it.BLACK,null,null);{const p=parseInt(u/2,10)+c,g=i(c,p),_=i(p+1,l);return h=t[p],d=n?n(h):h,new it(d,h.node,it.BLACK,g,_)}},r=function(c){let l=null,u=null,h=t.length;const d=function(g,_){const w=h-g,b=h;h-=g;const k=i(w+1,b),C=t[w],D=n?n(C):C;p(new it(D,C.node,_,null,k))},p=function(g){l?(l.left=g,l=g):(u=g,l=g)};for(let g=0;g<c.count;++g){const _=c.nextBitIsOne(),w=Math.pow(2,c.count-(g+1));_?d(w,it.BLACK):(d(w,it.BLACK),d(w,it.RED))}return u},o=new JP(t.length),a=r(o);return new Dt(s||e,a)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Yl;const di={};class Un{constructor(e,n){this.indexes_=e,this.indexSet_=n}static get Default(){return x(di&&vt,"ChildrenNode.ts has not been loaded"),Yl=Yl||new Un({".priority":di},{".priority":vt}),Yl}get(e){const n=Li(this.indexes_,e);if(!n)throw new Error("No index defined for "+e);return n instanceof Dt?n:null}hasIndex(e){return Gn(this.indexSet_,e.toString())}addIndex(e,n){x(e!==Oi,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const s=[];let i=!1;const r=n.getIterator(ue.Wrap);let o=r.getNext();for(;o;)i=i||e.isDefinedOn(o.node),s.push(o),o=r.getNext();let a;i?a=oc(s,e.getCompare()):a=di;const c=e.toString(),l=Object.assign({},this.indexSet_);l[c]=e;const u=Object.assign({},this.indexes_);return u[c]=a,new Un(u,l)}addToIndexes(e,n){const s=xa(this.indexes_,(i,r)=>{const o=Li(this.indexSet_,r);if(x(o,"Missing index implementation for "+r),i===di)if(o.isDefinedOn(e.node)){const a=[],c=n.getIterator(ue.Wrap);let l=c.getNext();for(;l;)l.name!==e.name&&a.push(l),l=c.getNext();return a.push(e),oc(a,o.getCompare())}else return di;else{const a=n.get(e.name);let c=i;return a&&(c=c.remove(new ue(e.name,a))),c.insert(e,e.node)}});return new Un(s,this.indexSet_)}removeFromIndexes(e,n){const s=xa(this.indexes_,i=>{if(i===di)return i;{const r=n.get(e.name);return r?i.remove(new ue(e.name,r)):i}});return new Un(s,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ex=!0;function mt(t,e=null){if(t===null)return ve.EMPTY_NODE;if(typeof t=="object"&&".priority"in t&&(e=t[".priority"]),x(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof t=="object"&&".value"in t&&t[".value"]!==null&&(t=t[".value"]),typeof t!="object"||".sv"in t){const n=t;return new nt(n,mt(e))}if(!(t instanceof Array)&&ex){const n=[];let s=!1;if(Xt(t,(o,a)=>{if(o.substring(0,1)!=="."){const c=mt(a);c.isEmpty()||(s=s||!c.getPriority().isEmpty(),n.push(new ue(o,c)))}}),n.length===0)return ve.EMPTY_NODE;const r=oc(n,KP,o=>o.name,uf);if(s){const o=oc(n,vt.getCompare());return new ve(r,mt(e),new Un({".priority":o},{".priority":vt}))}else return new ve(r,mt(e),Un.Default)}else{let n=ve.EMPTY_NODE;return Xt(t,(s,i)=>{if(Gn(t,s)&&s.substring(0,1)!=="."){const r=mt(i);(r.isLeafNode()||!r.isEmpty())&&(n=n.updateImmediateChild(s,r))}}),n.updatePriority(mt(e))}}GP(mt);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nx extends gl{compare(e,n){const s=e.node.compareTo(n.node);return s===0?cr(e.name,n.name):s}isDefinedOn(e){return!0}indexedValueChanged(e,n){return!e.equals(n)}minPost(){return ue.MIN}maxPost(){return ue.MAX}makePost(e,n){const s=mt(e);return new ue(n,s)}toString(){return".value"}}const sx=new nx;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ix(t){return{type:"value",snapshotNode:t}}function rx(t,e){return{type:"child_added",snapshotNode:e,childName:t}}function ox(t,e){return{type:"child_removed",snapshotNode:e,childName:t}}function dm(t,e,n){return{type:"child_changed",snapshotNode:e,childName:t,oldSnap:n}}function ax(t,e){return{type:"child_moved",snapshotNode:e,childName:t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ac extends PE{constructor(e,n,s,i){super(),this.repoInfo_=e,this.onDataUpdate_=n,this.authTokenProvider_=s,this.appCheckTokenProvider_=i,this.log_=jo("p:rest:"),this.listens_={}}reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,n){return n!==void 0?"tag$"+n:(x(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}listen(e,n,s,i){const r=e._path.toString();this.log_("Listen called for "+r+" "+e._queryIdentifier);const o=ac.getListenId_(e,s),a={};this.listens_[o]=a;const c=fm(e._queryParams);this.restRequest_(r+".json",c,(l,u)=>{let h=u;if(l===404&&(h=null,l=null),l===null&&this.onDataUpdate_(r,h,!1,s),Li(this.listens_,o)===a){let d;l?l===401?d="permission_denied":d="rest_error:"+l:d="ok",i(d,null)}})}unlisten(e,n){const s=ac.getListenId_(e,n);delete this.listens_[s]}get(e){const n=fm(e._queryParams),s=e._path.toString(),i=new Xr;return this.restRequest_(s+".json",n,(r,o)=>{let a=o;r===404&&(a=null,r=null),r===null?(this.onDataUpdate_(s,a,!1,null),i.resolve(a)):i.reject(new Error(a))}),i.promise}refreshAuthToken(e){}restRequest_(e,n={},s){return n.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then(([i,r])=>{i&&i.accessToken&&(n.auth=i.accessToken),r&&r.token&&(n.ac=r.token);const o=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+er(n);this.log_("Sending REST request for "+o);const a=new XMLHttpRequest;a.onreadystatechange=()=>{if(s&&a.readyState===4){this.log_("REST Response for "+o+" received. status:",a.status,"response:",a.responseText);let c=null;if(a.status>=200&&a.status<300){try{c=Jr(a.responseText)}catch{jt("Failed to parse JSON response for "+o+": "+a.responseText)}s(null,c)}else a.status!==401&&a.status!==404&&jt("Got unsuccessful REST response for "+o+" Status: "+a.status),s(a.status);s=null}},a.open("GET",o,!0),a.send()})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cx{constructor(){this.rootNode_=ve.EMPTY_NODE}getNode(e){return this.rootNode_.getChild(e)}updateSnapshot(e,n){this.rootNode_=this.rootNode_.updateChild(e,n)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function cc(){return{value:null,children:new Map}}function WE(t,e,n){if(ae(e))t.value=n,t.children.clear();else if(t.value!==null)t.value=t.value.updateChild(e,n);else{const s=le(e);t.children.has(s)||t.children.set(s,cc());const i=t.children.get(s);e=De(e),WE(i,e,n)}}function ch(t,e,n){t.value!==null?n(e,t.value):lx(t,(s,i)=>{const r=new xe(e.toString()+"/"+s);ch(i,r,n)})}function lx(t,e){t.children.forEach((n,s)=>{e(s,n)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ux{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),n=Object.assign({},e);return this.last_&&Xt(this.last_,(s,i)=>{n[s]=n[s]-i}),this.last_=e,n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gm=10*1e3,hx=30*1e3,dx=5*60*1e3;class fx{constructor(e,n){this.server_=n,this.statsToReport_={},this.statsListener_=new ux(e);const s=gm+(hx-gm)*Math.random();$r(this.reportStats_.bind(this),Math.floor(s))}reportStats_(){const e=this.statsListener_.get(),n={};let s=!1;Xt(e,(i,r)=>{r>0&&Gn(this.statsToReport_,i)&&(n[i]=r,s=!0)}),s&&this.server_.reportStats(n),$r(this.reportStats_.bind(this),Math.floor(Math.random()*2*dx))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var vn;(function(t){t[t.OVERWRITE=0]="OVERWRITE",t[t.MERGE=1]="MERGE",t[t.ACK_USER_WRITE=2]="ACK_USER_WRITE",t[t.LISTEN_COMPLETE=3]="LISTEN_COMPLETE"})(vn||(vn={}));function KE(){return{fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}function zE(){return{fromUser:!1,fromServer:!0,queryId:null,tagged:!1}}function GE(t){return{fromUser:!1,fromServer:!0,queryId:t,tagged:!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lc{constructor(e,n,s){this.path=e,this.affectedTree=n,this.revert=s,this.type=vn.ACK_USER_WRITE,this.source=KE()}operationForChild(e){if(ae(this.path)){if(this.affectedTree.value!=null)return x(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const n=this.affectedTree.subtree(new xe(e));return new lc(Ie(),n,this.revert)}}else return x(le(this.path)===e,"operationForChild called for unrelated child."),new lc(De(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Js{constructor(e,n,s){this.source=e,this.path=n,this.snap=s,this.type=vn.OVERWRITE}operationForChild(e){return ae(this.path)?new Js(this.source,Ie(),this.snap.getImmediateChild(e)):new Js(this.source,De(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mo{constructor(e,n,s){this.source=e,this.path=n,this.children=s,this.type=vn.MERGE}operationForChild(e){if(ae(this.path)){const n=this.children.subtree(new xe(e));return n.isEmpty()?null:n.value?new Js(this.source,Ie(),n.value):new mo(this.source,Ie(),n)}else return x(le(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new mo(this.source,De(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class df{constructor(e,n,s){this.node_=e,this.fullyInitialized_=n,this.filtered_=s}isFullyInitialized(){return this.fullyInitialized_}isFiltered(){return this.filtered_}isCompleteForPath(e){if(ae(e))return this.isFullyInitialized()&&!this.filtered_;const n=le(e);return this.isCompleteForChild(n)}isCompleteForChild(e){return this.isFullyInitialized()&&!this.filtered_||this.node_.hasChild(e)}getNode(){return this.node_}}function px(t,e,n,s){const i=[],r=[];return e.forEach(o=>{o.type==="child_changed"&&t.index_.indexedValueChanged(o.oldSnap,o.snapshotNode)&&r.push(ax(o.childName,o.snapshotNode))}),vr(t,i,"child_removed",e,s,n),vr(t,i,"child_added",e,s,n),vr(t,i,"child_moved",r,s,n),vr(t,i,"child_changed",e,s,n),vr(t,i,"value",e,s,n),i}function vr(t,e,n,s,i,r){const o=s.filter(a=>a.type===n);o.sort((a,c)=>mx(t,a,c)),o.forEach(a=>{const c=gx(t,a,r);i.forEach(l=>{l.respondsTo(a.type)&&e.push(l.createEvent(c,t.query_))})})}function gx(t,e,n){return e.type==="value"||e.type==="child_removed"||(e.prevName=n.getPredecessorChildName(e.childName,e.snapshotNode,t.index_)),e}function mx(t,e,n){if(e.childName==null||n.childName==null)throw Ji("Should only compare child_ events.");const s=new ue(e.childName,e.snapshotNode),i=new ue(n.childName,n.snapshotNode);return t.index_.compare(s,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function QE(t,e){return{eventCache:t,serverCache:e}}function Vr(t,e,n,s){return QE(new df(e,n,s),t.serverCache)}function YE(t,e,n,s){return QE(t.eventCache,new df(e,n,s))}function lh(t){return t.eventCache.isFullyInitialized()?t.eventCache.getNode():null}function Zs(t){return t.serverCache.isFullyInitialized()?t.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hn{constructor(e){this.writeTree_=e}static empty(){return new hn(new Ne(null))}}function jr(t,e,n){if(ae(e))return new hn(new Ne(n));{const s=t.writeTree_.findRootMostValueAndPath(e);if(s!=null){const i=s.path;let r=s.value;const o=Kt(i,e);return r=r.updateChild(o,n),new hn(t.writeTree_.set(i,r))}else{const i=new Ne(n),r=t.writeTree_.setTree(e,i);return new hn(r)}}}function mm(t,e,n){let s=t;return Xt(n,(i,r)=>{s=jr(s,rt(e,i),r)}),s}function _m(t,e){if(ae(e))return hn.empty();{const n=t.writeTree_.setTree(e,new Ne(null));return new hn(n)}}function uh(t,e){return ai(t,e)!=null}function ai(t,e){const n=t.writeTree_.findRootMostValueAndPath(e);return n!=null?t.writeTree_.get(n.path).getChild(Kt(n.path,e)):null}function ym(t){const e=[],n=t.writeTree_.value;return n!=null?n.isLeafNode()||n.forEachChild(vt,(s,i)=>{e.push(new ue(s,i))}):t.writeTree_.children.inorderTraversal((s,i)=>{i.value!=null&&e.push(new ue(s,i.value))}),e}function us(t,e){if(ae(e))return t;{const n=ai(t,e);return n!=null?new hn(new Ne(n)):new hn(t.writeTree_.subtree(e))}}function hh(t){return t.writeTree_.isEmpty()}function zi(t,e){return XE(Ie(),t.writeTree_,e)}function XE(t,e,n){if(e.value!=null)return n.updateChild(t,e.value);{let s=null;return e.children.inorderTraversal((i,r)=>{i===".priority"?(x(r.value!==null,"Priority writes must always be leaf nodes"),s=r.value):n=XE(rt(t,i),r,n)}),!n.getChild(t).isEmpty()&&s!==null&&(n=n.updateChild(rt(t,".priority"),s)),n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function JE(t,e){return sT(e,t)}function yx(t,e,n,s,i){x(s>t.lastWriteId,"Stacking an older write on top of newer ones"),i===void 0&&(i=!0),t.allWrites.push({path:e,snap:n,writeId:s,visible:i}),i&&(t.visibleWrites=jr(t.visibleWrites,e,n)),t.lastWriteId=s}function vx(t,e){for(let n=0;n<t.allWrites.length;n++){const s=t.allWrites[n];if(s.writeId===e)return s}return null}function wx(t,e){const n=t.allWrites.findIndex(a=>a.writeId===e);x(n>=0,"removeWrite called with nonexistent writeId.");const s=t.allWrites[n];t.allWrites.splice(n,1);let i=s.visible,r=!1,o=t.allWrites.length-1;for(;i&&o>=0;){const a=t.allWrites[o];a.visible&&(o>=n&&Ex(a,s.path)?i=!1:an(s.path,a.path)&&(r=!0)),o--}if(i){if(r)return Tx(t),!0;if(s.snap)t.visibleWrites=_m(t.visibleWrites,s.path);else{const a=s.children;Xt(a,c=>{t.visibleWrites=_m(t.visibleWrites,rt(s.path,c))})}return!0}else return!1}function Ex(t,e){if(t.snap)return an(t.path,e);for(const n in t.children)if(t.children.hasOwnProperty(n)&&an(rt(t.path,n),e))return!0;return!1}function Tx(t){t.visibleWrites=ZE(t.allWrites,bx,Ie()),t.allWrites.length>0?t.lastWriteId=t.allWrites[t.allWrites.length-1].writeId:t.lastWriteId=-1}function bx(t){return t.visible}function ZE(t,e,n){let s=hn.empty();for(let i=0;i<t.length;++i){const r=t[i];if(e(r)){const o=r.path;let a;if(r.snap)an(n,o)?(a=Kt(n,o),s=jr(s,a,r.snap)):an(o,n)&&(a=Kt(o,n),s=jr(s,Ie(),r.snap.getChild(a)));else if(r.children){if(an(n,o))a=Kt(n,o),s=mm(s,a,r.children);else if(an(o,n))if(a=Kt(o,n),ae(a))s=mm(s,Ie(),r.children);else{const c=Li(r.children,le(a));if(c){const l=c.getChild(De(a));s=jr(s,Ie(),l)}}}else throw Ji("WriteRecord should have .snap or .children")}}return s}function eT(t,e,n,s,i){if(!s&&!i){const r=ai(t.visibleWrites,e);if(r!=null)return r;{const o=us(t.visibleWrites,e);if(hh(o))return n;if(n==null&&!uh(o,Ie()))return null;{const a=n||ve.EMPTY_NODE;return zi(o,a)}}}else{const r=us(t.visibleWrites,e);if(!i&&hh(r))return n;if(!i&&n==null&&!uh(r,Ie()))return null;{const o=function(l){return(l.visible||i)&&(!s||!~s.indexOf(l.writeId))&&(an(l.path,e)||an(e,l.path))},a=ZE(t.allWrites,o,e),c=n||ve.EMPTY_NODE;return zi(a,c)}}}function Ix(t,e,n){let s=ve.EMPTY_NODE;const i=ai(t.visibleWrites,e);if(i)return i.isLeafNode()||i.forEachChild(vt,(r,o)=>{s=s.updateImmediateChild(r,o)}),s;if(n){const r=us(t.visibleWrites,e);return n.forEachChild(vt,(o,a)=>{const c=zi(us(r,new xe(o)),a);s=s.updateImmediateChild(o,c)}),ym(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}else{const r=us(t.visibleWrites,e);return ym(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}}function Cx(t,e,n,s,i){x(s||i,"Either existingEventSnap or existingServerSnap must exist");const r=rt(e,n);if(uh(t.visibleWrites,r))return null;{const o=us(t.visibleWrites,r);return hh(o)?i.getChild(n):zi(o,i.getChild(n))}}function Sx(t,e,n,s){const i=rt(e,n),r=ai(t.visibleWrites,i);if(r!=null)return r;if(s.isCompleteForChild(n)){const o=us(t.visibleWrites,i);return zi(o,s.getNode().getImmediateChild(n))}else return null}function Rx(t,e){return ai(t.visibleWrites,e)}function Ax(t,e,n,s,i,r,o){let a;const c=us(t.visibleWrites,e),l=ai(c,Ie());if(l!=null)a=l;else if(n!=null)a=zi(c,n);else return[];if(a=a.withIndex(o),!a.isEmpty()&&!a.isLeafNode()){const u=[],h=o.getCompare(),d=r?a.getReverseIteratorFrom(s,o):a.getIteratorFrom(s,o);let p=d.getNext();for(;p&&u.length<i;)h(p,s)!==0&&u.push(p),p=d.getNext();return u}else return[]}function kx(){return{visibleWrites:hn.empty(),allWrites:[],lastWriteId:-1}}function dh(t,e,n,s){return eT(t.writeTree,t.treePath,e,n,s)}function tT(t,e){return Ix(t.writeTree,t.treePath,e)}function vm(t,e,n,s){return Cx(t.writeTree,t.treePath,e,n,s)}function uc(t,e){return Rx(t.writeTree,rt(t.treePath,e))}function Nx(t,e,n,s,i,r){return Ax(t.writeTree,t.treePath,e,n,s,i,r)}function ff(t,e,n){return Sx(t.writeTree,t.treePath,e,n)}function nT(t,e){return sT(rt(t.treePath,e),t.writeTree)}function sT(t,e){return{treePath:t,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ox{constructor(){this.changeMap=new Map}trackChildChange(e){const n=e.type,s=e.childName;x(n==="child_added"||n==="child_changed"||n==="child_removed","Only child changes supported for tracking"),x(s!==".priority","Only non-priority child changes can be tracked.");const i=this.changeMap.get(s);if(i){const r=i.type;if(n==="child_added"&&r==="child_removed")this.changeMap.set(s,dm(s,e.snapshotNode,i.snapshotNode));else if(n==="child_removed"&&r==="child_added")this.changeMap.delete(s);else if(n==="child_removed"&&r==="child_changed")this.changeMap.set(s,ox(s,i.oldSnap));else if(n==="child_changed"&&r==="child_added")this.changeMap.set(s,rx(s,e.snapshotNode));else if(n==="child_changed"&&r==="child_changed")this.changeMap.set(s,dm(s,e.snapshotNode,i.oldSnap));else throw Ji("Illegal combination of changes: "+e+" occurred after "+i)}else this.changeMap.set(s,e)}getChanges(){return Array.from(this.changeMap.values())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dx{getCompleteChild(e){return null}getChildAfterChild(e,n,s){return null}}const iT=new Dx;class pf{constructor(e,n,s=null){this.writes_=e,this.viewCache_=n,this.optCompleteServerCache_=s}getCompleteChild(e){const n=this.viewCache_.eventCache;if(n.isCompleteForChild(e))return n.getNode().getImmediateChild(e);{const s=this.optCompleteServerCache_!=null?new df(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return ff(this.writes_,e,s)}}getChildAfterChild(e,n,s){const i=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:Zs(this.viewCache_),r=Nx(this.writes_,i,n,1,s,e);return r.length===0?null:r[0]}}function Px(t,e){x(e.eventCache.getNode().isIndexed(t.filter.getIndex()),"Event snap not indexed"),x(e.serverCache.getNode().isIndexed(t.filter.getIndex()),"Server snap not indexed")}function xx(t,e,n,s,i){const r=new Ox;let o,a;if(n.type===vn.OVERWRITE){const l=n;l.source.fromUser?o=fh(t,e,l.path,l.snap,s,i,r):(x(l.source.fromServer,"Unknown source."),a=l.source.tagged||e.serverCache.isFiltered()&&!ae(l.path),o=hc(t,e,l.path,l.snap,s,i,a,r))}else if(n.type===vn.MERGE){const l=n;l.source.fromUser?o=Lx(t,e,l.path,l.children,s,i,r):(x(l.source.fromServer,"Unknown source."),a=l.source.tagged||e.serverCache.isFiltered(),o=ph(t,e,l.path,l.children,s,i,a,r))}else if(n.type===vn.ACK_USER_WRITE){const l=n;l.revert?o=Bx(t,e,l.path,s,i,r):o=Fx(t,e,l.path,l.affectedTree,s,i,r)}else if(n.type===vn.LISTEN_COMPLETE)o=Ux(t,e,n.path,s,r);else throw Ji("Unknown operation type: "+n.type);const c=r.getChanges();return Mx(e,o,c),{viewCache:o,changes:c}}function Mx(t,e,n){const s=e.eventCache;if(s.isFullyInitialized()){const i=s.getNode().isLeafNode()||s.getNode().isEmpty(),r=lh(t);(n.length>0||!t.eventCache.isFullyInitialized()||i&&!s.getNode().equals(r)||!s.getNode().getPriority().equals(r.getPriority()))&&n.push(ix(lh(e)))}}function rT(t,e,n,s,i,r){const o=e.eventCache;if(uc(s,n)!=null)return e;{let a,c;if(ae(n))if(x(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const l=Zs(e),u=l instanceof ve?l:ve.EMPTY_NODE,h=tT(s,u);a=t.filter.updateFullNode(e.eventCache.getNode(),h,r)}else{const l=dh(s,Zs(e));a=t.filter.updateFullNode(e.eventCache.getNode(),l,r)}else{const l=le(n);if(l===".priority"){x(_s(n)===1,"Can't have a priority with additional path components");const u=o.getNode();c=e.serverCache.getNode();const h=vm(s,n,u,c);h!=null?a=t.filter.updatePriority(u,h):a=o.getNode()}else{const u=De(n);let h;if(o.isCompleteForChild(l)){c=e.serverCache.getNode();const d=vm(s,n,o.getNode(),c);d!=null?h=o.getNode().getImmediateChild(l).updateChild(u,d):h=o.getNode().getImmediateChild(l)}else h=ff(s,l,e.serverCache);h!=null?a=t.filter.updateChild(o.getNode(),l,h,u,i,r):a=o.getNode()}}return Vr(e,a,o.isFullyInitialized()||ae(n),t.filter.filtersNodes())}}function hc(t,e,n,s,i,r,o,a){const c=e.serverCache;let l;const u=o?t.filter:t.filter.getIndexedFilter();if(ae(n))l=u.updateFullNode(c.getNode(),s,null);else if(u.filtersNodes()&&!c.isFiltered()){const p=c.getNode().updateChild(n,s);l=u.updateFullNode(c.getNode(),p,null)}else{const p=le(n);if(!c.isCompleteForPath(n)&&_s(n)>1)return e;const g=De(n),w=c.getNode().getImmediateChild(p).updateChild(g,s);p===".priority"?l=u.updatePriority(c.getNode(),w):l=u.updateChild(c.getNode(),p,w,g,iT,null)}const h=YE(e,l,c.isFullyInitialized()||ae(n),u.filtersNodes()),d=new pf(i,h,r);return rT(t,h,n,i,d,a)}function fh(t,e,n,s,i,r,o){const a=e.eventCache;let c,l;const u=new pf(i,e,r);if(ae(n))l=t.filter.updateFullNode(e.eventCache.getNode(),s,o),c=Vr(e,l,!0,t.filter.filtersNodes());else{const h=le(n);if(h===".priority")l=t.filter.updatePriority(e.eventCache.getNode(),s),c=Vr(e,l,a.isFullyInitialized(),a.isFiltered());else{const d=De(n),p=a.getNode().getImmediateChild(h);let g;if(ae(d))g=s;else{const _=u.getCompleteChild(h);_!=null?ME(d)===".priority"&&_.getChild(FE(d)).isEmpty()?g=_:g=_.updateChild(d,s):g=ve.EMPTY_NODE}if(p.equals(g))c=e;else{const _=t.filter.updateChild(a.getNode(),h,g,d,u,o);c=Vr(e,_,a.isFullyInitialized(),t.filter.filtersNodes())}}}return c}function wm(t,e){return t.eventCache.isCompleteForChild(e)}function Lx(t,e,n,s,i,r,o){let a=e;return s.foreach((c,l)=>{const u=rt(n,c);wm(e,le(u))&&(a=fh(t,a,u,l,i,r,o))}),s.foreach((c,l)=>{const u=rt(n,c);wm(e,le(u))||(a=fh(t,a,u,l,i,r,o))}),a}function Em(t,e,n){return n.foreach((s,i)=>{e=e.updateChild(s,i)}),e}function ph(t,e,n,s,i,r,o,a){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let c=e,l;ae(n)?l=s:l=new Ne(null).setTree(n,s);const u=e.serverCache.getNode();return l.children.inorderTraversal((h,d)=>{if(u.hasChild(h)){const p=e.serverCache.getNode().getImmediateChild(h),g=Em(t,p,d);c=hc(t,c,new xe(h),g,i,r,o,a)}}),l.children.inorderTraversal((h,d)=>{const p=!e.serverCache.isCompleteForChild(h)&&d.value===null;if(!u.hasChild(h)&&!p){const g=e.serverCache.getNode().getImmediateChild(h),_=Em(t,g,d);c=hc(t,c,new xe(h),_,i,r,o,a)}}),c}function Fx(t,e,n,s,i,r,o){if(uc(i,n)!=null)return e;const a=e.serverCache.isFiltered(),c=e.serverCache;if(s.value!=null){if(ae(n)&&c.isFullyInitialized()||c.isCompleteForPath(n))return hc(t,e,n,c.getNode().getChild(n),i,r,a,o);if(ae(n)){let l=new Ne(null);return c.getNode().forEachChild(Oi,(u,h)=>{l=l.set(new xe(u),h)}),ph(t,e,n,l,i,r,a,o)}else return e}else{let l=new Ne(null);return s.foreach((u,h)=>{const d=rt(n,u);c.isCompleteForPath(d)&&(l=l.set(u,c.getNode().getChild(d)))}),ph(t,e,n,l,i,r,a,o)}}function Ux(t,e,n,s,i){const r=e.serverCache,o=YE(e,r.getNode(),r.isFullyInitialized()||ae(n),r.isFiltered());return rT(t,o,n,s,iT,i)}function Bx(t,e,n,s,i,r){let o;if(uc(s,n)!=null)return e;{const a=new pf(s,e,i),c=e.eventCache.getNode();let l;if(ae(n)||le(n)===".priority"){let u;if(e.serverCache.isFullyInitialized())u=dh(s,Zs(e));else{const h=e.serverCache.getNode();x(h instanceof ve,"serverChildren would be complete if leaf node"),u=tT(s,h)}u=u,l=t.filter.updateFullNode(c,u,r)}else{const u=le(n);let h=ff(s,u,e.serverCache);h==null&&e.serverCache.isCompleteForChild(u)&&(h=c.getImmediateChild(u)),h!=null?l=t.filter.updateChild(c,u,h,De(n),a,r):e.eventCache.getNode().hasChild(u)?l=t.filter.updateChild(c,u,ve.EMPTY_NODE,De(n),a,r):l=c,l.isEmpty()&&e.serverCache.isFullyInitialized()&&(o=dh(s,Zs(e)),o.isLeafNode()&&(l=t.filter.updateFullNode(l,o,r)))}return o=e.serverCache.isFullyInitialized()||uc(s,Ie())!=null,Vr(e,l,o,t.filter.filtersNodes())}}function $x(t,e){const n=Zs(t.viewCache_);return n&&(t.query._queryParams.loadsAllData()||!ae(e)&&!n.getImmediateChild(le(e)).isEmpty())?n.getChild(e):null}function Tm(t,e,n,s){e.type===vn.MERGE&&e.source.queryId!==null&&(x(Zs(t.viewCache_),"We should always have a full cache before handling merges"),x(lh(t.viewCache_),"Missing event cache, even though we have a server cache"));const i=t.viewCache_,r=xx(t.processor_,i,e,n,s);return Px(t.processor_,r.viewCache),x(r.viewCache.serverCache.isFullyInitialized()||!i.serverCache.isFullyInitialized(),"Once a server snap is complete, it should never go back"),t.viewCache_=r.viewCache,Vx(t,r.changes,r.viewCache.eventCache.getNode(),null)}function Vx(t,e,n,s){const i=s?[s]:t.eventRegistrations_;return px(t.eventGenerator_,e,n,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let bm;function jx(t){x(!bm,"__referenceConstructor has already been defined"),bm=t}function gf(t,e,n,s){const i=e.source.queryId;if(i!==null){const r=t.views.get(i);return x(r!=null,"SyncTree gave us an op for an invalid query."),Tm(r,e,n,s)}else{let r=[];for(const o of t.views.values())r=r.concat(Tm(o,e,n,s));return r}}function mf(t,e){let n=null;for(const s of t.views.values())n=n||$x(s,e);return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Im;function Hx(t){x(!Im,"__referenceConstructor has already been defined"),Im=t}class Cm{constructor(e){this.listenProvider_=e,this.syncPointTree_=new Ne(null),this.pendingWriteTree_=kx(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function qx(t,e,n,s,i){return yx(t.pendingWriteTree_,e,n,s,i),i?_l(t,new Js(KE(),e,n)):[]}function wi(t,e,n=!1){const s=vx(t.pendingWriteTree_,e);if(wx(t.pendingWriteTree_,e)){let r=new Ne(null);return s.snap!=null?r=r.set(Ie(),!0):Xt(s.children,o=>{r=r.set(new xe(o),!0)}),_l(t,new lc(s.path,r,n))}else return[]}function ml(t,e,n){return _l(t,new Js(zE(),e,n))}function Wx(t,e,n){const s=Ne.fromObject(n);return _l(t,new mo(zE(),e,s))}function Kx(t,e,n,s){const i=lT(t,s);if(i!=null){const r=uT(i),o=r.path,a=r.queryId,c=Kt(o,e),l=new Js(GE(a),c,n);return hT(t,o,l)}else return[]}function zx(t,e,n,s){const i=lT(t,s);if(i){const r=uT(i),o=r.path,a=r.queryId,c=Kt(o,e),l=Ne.fromObject(n),u=new mo(GE(a),c,l);return hT(t,o,u)}else return[]}function oT(t,e,n){const i=t.pendingWriteTree_,r=t.syncPointTree_.findOnPath(e,(o,a)=>{const c=Kt(o,e),l=mf(a,c);if(l)return l});return eT(i,e,r,n,!0)}function _l(t,e){return aT(e,t.syncPointTree_,null,JE(t.pendingWriteTree_,Ie()))}function aT(t,e,n,s){if(ae(t.path))return cT(t,e,n,s);{const i=e.get(Ie());n==null&&i!=null&&(n=mf(i,Ie()));let r=[];const o=le(t.path),a=t.operationForChild(o),c=e.children.get(o);if(c&&a){const l=n?n.getImmediateChild(o):null,u=nT(s,o);r=r.concat(aT(a,c,l,u))}return i&&(r=r.concat(gf(i,t,s,n))),r}}function cT(t,e,n,s){const i=e.get(Ie());n==null&&i!=null&&(n=mf(i,Ie()));let r=[];return e.children.inorderTraversal((o,a)=>{const c=n?n.getImmediateChild(o):null,l=nT(s,o),u=t.operationForChild(o);u&&(r=r.concat(cT(u,a,c,l)))}),i&&(r=r.concat(gf(i,t,s,n))),r}function lT(t,e){return t.tagToQueryMap.get(e)}function uT(t){const e=t.indexOf("$");return x(e!==-1&&e<t.length-1,"Bad queryKey."),{queryId:t.substr(e+1),path:new xe(t.substr(0,e))}}function hT(t,e,n){const s=t.syncPointTree_.get(e);x(s,"Missing sync point for query tag that we're tracking");const i=JE(t.pendingWriteTree_,e);return gf(s,n,i,null)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _f{constructor(e){this.node_=e}getImmediateChild(e){const n=this.node_.getImmediateChild(e);return new _f(n)}node(){return this.node_}}class yf{constructor(e,n){this.syncTree_=e,this.path_=n}getImmediateChild(e){const n=rt(this.path_,e);return new yf(this.syncTree_,n)}node(){return oT(this.syncTree_,this.path_)}}const Gx=function(t){return t=t||{},t.timestamp=t.timestamp||new Date().getTime(),t},Sm=function(t,e,n){if(!t||typeof t!="object")return t;if(x(".sv"in t,"Unexpected leaf node or priority contents"),typeof t[".sv"]=="string")return Qx(t[".sv"],e,n);if(typeof t[".sv"]=="object")return Yx(t[".sv"],e);x(!1,"Unexpected server value: "+JSON.stringify(t,null,2))},Qx=function(t,e,n){switch(t){case"timestamp":return n.timestamp;default:x(!1,"Unexpected server value: "+t)}},Yx=function(t,e,n){t.hasOwnProperty("increment")||x(!1,"Unexpected server value: "+JSON.stringify(t,null,2));const s=t.increment;typeof s!="number"&&x(!1,"Unexpected increment value: "+s);const i=e.node();if(x(i!==null&&typeof i<"u","Expected ChildrenNode.EMPTY_NODE for nulls"),!i.isLeafNode())return s;const o=i.getValue();return typeof o!="number"?s:o+s},Xx=function(t,e,n,s){return vf(e,new yf(n,t),s)},Jx=function(t,e,n){return vf(t,new _f(e),n)};function vf(t,e,n){const s=t.getPriority().val(),i=Sm(s,e.getImmediateChild(".priority"),n);let r;if(t.isLeafNode()){const o=t,a=Sm(o.getValue(),e,n);return a!==o.getValue()||i!==o.getPriority().val()?new nt(a,mt(i)):t}else{const o=t;return r=o,i!==o.getPriority().val()&&(r=r.updatePriority(new nt(i))),o.forEachChild(vt,(a,c)=>{const l=vf(c,e.getImmediateChild(a),n);l!==c&&(r=r.updateImmediateChild(a,l))}),r}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wf{constructor(e="",n=null,s={children:{},childCount:0}){this.name=e,this.parent=n,this.node=s}}function Ef(t,e){let n=e instanceof xe?e:new xe(e),s=t,i=le(n);for(;i!==null;){const r=Li(s.node.children,i)||{children:{},childCount:0};s=new wf(i,s,r),n=De(n),i=le(n)}return s}function lr(t){return t.node.value}function dT(t,e){t.node.value=e,gh(t)}function fT(t){return t.node.childCount>0}function Zx(t){return lr(t)===void 0&&!fT(t)}function yl(t,e){Xt(t.node.children,(n,s)=>{e(new wf(n,t,s))})}function pT(t,e,n,s){n&&!s&&e(t),yl(t,i=>{pT(i,e,!0,s)}),n&&s&&e(t)}function eM(t,e,n){let s=n?t:t.parent;for(;s!==null;){if(e(s))return!0;s=s.parent}return!1}function Wo(t){return new xe(t.parent===null?t.name:Wo(t.parent)+"/"+t.name)}function gh(t){t.parent!==null&&tM(t.parent,t.name,t)}function tM(t,e,n){const s=Zx(n),i=Gn(t.node.children,e);s&&i?(delete t.node.children[e],t.node.childCount--,gh(t)):!s&&!i&&(t.node.children[e]=n.node,t.node.childCount++,gh(t))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nM=/[\[\].#$\/\u0000-\u001F\u007F]/,sM=/[\[\].#$\u0000-\u001F\u007F]/,Jl=10*1024*1024,gT=function(t){return typeof t=="string"&&t.length!==0&&!nM.test(t)},iM=function(t){return typeof t=="string"&&t.length!==0&&!sM.test(t)},rM=function(t){return t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),iM(t)},mT=function(t,e,n){const s=n instanceof xe?new UP(n,t):n;if(e===void 0)throw new Error(t+"contains undefined "+As(s));if(typeof e=="function")throw new Error(t+"contains a function "+As(s)+" with contents = "+e.toString());if(gE(e))throw new Error(t+"contains "+e.toString()+" "+As(s));if(typeof e=="string"&&e.length>Jl/3&&Nc(e)>Jl)throw new Error(t+"contains a string greater than "+Jl+" utf8 bytes "+As(s)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let i=!1,r=!1;if(Xt(e,(o,a)=>{if(o===".value")i=!0;else if(o!==".priority"&&o!==".sv"&&(r=!0,!gT(o)))throw new Error(t+" contains an invalid key ("+o+") "+As(s)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);BP(s,o),mT(t,a,s),$P(s)}),i&&r)throw new Error(t+' contains ".value" child '+As(s)+" in addition to actual children.")}},oM=function(t,e){const n=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!gT(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||n.length!==0&&!rM(n))throw new Error(DC(t,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class aM{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function cM(t,e){let n=null;for(let s=0;s<e.length;s++){const i=e[s],r=i.getPath();n!==null&&!UE(r,n.path)&&(t.eventLists_.push(n),n=null),n===null&&(n={events:[],path:r}),n.events.push(i)}n&&t.eventLists_.push(n)}function ci(t,e,n){cM(t,n),lM(t,s=>an(s,e)||an(e,s))}function lM(t,e){t.recursionDepth_++;let n=!0;for(let s=0;s<t.eventLists_.length;s++){const i=t.eventLists_[s];if(i){const r=i.path;e(r)?(uM(t.eventLists_[s]),t.eventLists_[s]=null):n=!1}}n&&(t.eventLists_=[]),t.recursionDepth_--}function uM(t){for(let e=0;e<t.events.length;e++){const n=t.events[e];if(n!==null){t.events[e]=null;const s=n.getEventRunner();Hs&&gt("event: "+n.toString()),Ho(s)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hM="repo_interrupt",dM=25;class fM{constructor(e,n,s,i){this.repoInfo_=e,this.forceRestClient_=n,this.authTokenProvider_=s,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new aM,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=cc(),this.transactionQueueTree_=new wf,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function pM(t,e,n){if(t.stats_=af(t.repoInfo_),t.forceRestClient_||cP())t.server_=new ac(t.repoInfo_,(s,i,r,o)=>{Rm(t,s,i,r,o)},t.authTokenProvider_,t.appCheckProvider_),setTimeout(()=>Am(t,!0),0);else{if(typeof n<"u"&&n!==null){if(typeof n!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{ct(n)}catch(s){throw new Error("Invalid authOverride provided: "+s)}}t.persistentConnection_=new $n(t.repoInfo_,e,(s,i,r,o)=>{Rm(t,s,i,r,o)},s=>{Am(t,s)},s=>{mM(t,s)},t.authTokenProvider_,t.appCheckProvider_,n),t.server_=t.persistentConnection_}t.authTokenProvider_.addTokenChangeListener(s=>{t.server_.refreshAuthToken(s)}),t.appCheckProvider_.addTokenChangeListener(s=>{t.server_.refreshAppCheckToken(s.token)}),t.statsReporter_=pP(t.repoInfo_,()=>new fx(t.stats_,t.server_)),t.infoData_=new cx,t.infoSyncTree_=new Cm({startListening:(s,i,r,o)=>{let a=[];const c=t.infoData_.getNode(s._path);return c.isEmpty()||(a=ml(t.infoSyncTree_,s._path,c),setTimeout(()=>{o("ok")},0)),a},stopListening:()=>{}}),Tf(t,"connected",!1),t.serverSyncTree_=new Cm({startListening:(s,i,r,o)=>(t.server_.listen(s,r,i,(a,c)=>{const l=o(a,c);ci(t.eventQueue_,s._path,l)}),[]),stopListening:(s,i)=>{t.server_.unlisten(s,i)}})}function gM(t){const n=t.infoData_.getNode(new xe(".info/serverTimeOffset")).val()||0;return new Date().getTime()+n}function _T(t){return Gx({timestamp:gM(t)})}function Rm(t,e,n,s,i){t.dataUpdateCount++;const r=new xe(e);n=t.interceptServerDataCallback_?t.interceptServerDataCallback_(e,n):n;let o=[];if(i)if(s){const c=xa(n,l=>mt(l));o=zx(t.serverSyncTree_,r,c,i)}else{const c=mt(n);o=Kx(t.serverSyncTree_,r,c,i)}else if(s){const c=xa(n,l=>mt(l));o=Wx(t.serverSyncTree_,r,c)}else{const c=mt(n);o=ml(t.serverSyncTree_,r,c)}let a=r;o.length>0&&(a=If(t,r)),ci(t.eventQueue_,a,o)}function Am(t,e){Tf(t,"connected",e),e===!1&&yM(t)}function mM(t,e){Xt(e,(n,s)=>{Tf(t,n,s)})}function Tf(t,e,n){const s=new xe("/.info/"+e),i=mt(n);t.infoData_.updateSnapshot(s,i);const r=ml(t.infoSyncTree_,s,i);ci(t.eventQueue_,s,r)}function _M(t){return t.nextWriteId_++}function yM(t){yT(t,"onDisconnectEvents");const e=_T(t),n=cc();ch(t.onDisconnect_,Ie(),(i,r)=>{const o=Xx(i,r,t.serverSyncTree_,e);WE(n,i,o)});let s=[];ch(n,Ie(),(i,r)=>{s=s.concat(ml(t.serverSyncTree_,i,r));const o=TM(t,i);If(t,o)}),t.onDisconnect_=cc(),ci(t.eventQueue_,Ie(),s)}function vM(t){t.persistentConnection_&&t.persistentConnection_.interrupt(hM)}function yT(t,...e){let n="";t.persistentConnection_&&(n=t.persistentConnection_.id+":"),gt(n,...e)}function vT(t,e,n){return oT(t.serverSyncTree_,e,n)||ve.EMPTY_NODE}function bf(t,e=t.transactionQueueTree_){if(e||vl(t,e),lr(e)){const n=ET(t,e);x(n.length>0,"Sending zero length transaction queue"),n.every(i=>i.status===0)&&wM(t,Wo(e),n)}else fT(e)&&yl(e,n=>{bf(t,n)})}function wM(t,e,n){const s=n.map(l=>l.currentWriteId),i=vT(t,e,s);let r=i;const o=i.hash();for(let l=0;l<n.length;l++){const u=n[l];x(u.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),u.status=1,u.retryCount++;const h=Kt(e,u.path);r=r.updateChild(h,u.currentOutputSnapshotRaw)}const a=r.val(!0),c=e;t.server_.put(c.toString(),a,l=>{yT(t,"transaction put response",{path:c.toString(),status:l});let u=[];if(l==="ok"){const h=[];for(let d=0;d<n.length;d++)n[d].status=2,u=u.concat(wi(t.serverSyncTree_,n[d].currentWriteId)),n[d].onComplete&&h.push(()=>n[d].onComplete(null,!0,n[d].currentOutputSnapshotResolved)),n[d].unwatcher();vl(t,Ef(t.transactionQueueTree_,e)),bf(t,t.transactionQueueTree_),ci(t.eventQueue_,e,u);for(let d=0;d<h.length;d++)Ho(h[d])}else{if(l==="datastale")for(let h=0;h<n.length;h++)n[h].status===3?n[h].status=4:n[h].status=0;else{jt("transaction at "+c.toString()+" failed: "+l);for(let h=0;h<n.length;h++)n[h].status=4,n[h].abortReason=l}If(t,e)}},o)}function If(t,e){const n=wT(t,e),s=Wo(n),i=ET(t,n);return EM(t,i,s),s}function EM(t,e,n){if(e.length===0)return;const s=[];let i=[];const o=e.filter(a=>a.status===0).map(a=>a.currentWriteId);for(let a=0;a<e.length;a++){const c=e[a],l=Kt(n,c.path);let u=!1,h;if(x(l!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),c.status===4)u=!0,h=c.abortReason,i=i.concat(wi(t.serverSyncTree_,c.currentWriteId,!0));else if(c.status===0)if(c.retryCount>=dM)u=!0,h="maxretry",i=i.concat(wi(t.serverSyncTree_,c.currentWriteId,!0));else{const d=vT(t,c.path,o);c.currentInputSnapshot=d;const p=e[a].update(d.val());if(p!==void 0){mT("transaction failed: Data returned ",p,c.path);let g=mt(p);typeof p=="object"&&p!=null&&Gn(p,".priority")||(g=g.updatePriority(d.getPriority()));const w=c.currentWriteId,b=_T(t),k=Jx(g,d,b);c.currentOutputSnapshotRaw=g,c.currentOutputSnapshotResolved=k,c.currentWriteId=_M(t),o.splice(o.indexOf(w),1),i=i.concat(qx(t.serverSyncTree_,c.path,k,c.currentWriteId,c.applyLocally)),i=i.concat(wi(t.serverSyncTree_,w,!0))}else u=!0,h="nodata",i=i.concat(wi(t.serverSyncTree_,c.currentWriteId,!0))}ci(t.eventQueue_,n,i),i=[],u&&(e[a].status=2,function(d){setTimeout(d,Math.floor(0))}(e[a].unwatcher),e[a].onComplete&&(h==="nodata"?s.push(()=>e[a].onComplete(null,!1,e[a].currentInputSnapshot)):s.push(()=>e[a].onComplete(new Error(h),!1,null))))}vl(t,t.transactionQueueTree_);for(let a=0;a<s.length;a++)Ho(s[a]);bf(t,t.transactionQueueTree_)}function wT(t,e){let n,s=t.transactionQueueTree_;for(n=le(e);n!==null&&lr(s)===void 0;)s=Ef(s,n),e=De(e),n=le(e);return s}function ET(t,e){const n=[];return TT(t,e,n),n.sort((s,i)=>s.order-i.order),n}function TT(t,e,n){const s=lr(e);if(s)for(let i=0;i<s.length;i++)n.push(s[i]);yl(e,i=>{TT(t,i,n)})}function vl(t,e){const n=lr(e);if(n){let s=0;for(let i=0;i<n.length;i++)n[i].status!==2&&(n[s]=n[i],s++);n.length=s,dT(e,n.length>0?n:void 0)}yl(e,s=>{vl(t,s)})}function TM(t,e){const n=Wo(wT(t,e)),s=Ef(t.transactionQueueTree_,e);return eM(s,i=>{Zl(t,i)}),Zl(t,s),pT(s,i=>{Zl(t,i)}),n}function Zl(t,e){const n=lr(e);if(n){const s=[];let i=[],r=-1;for(let o=0;o<n.length;o++)n[o].status===3||(n[o].status===1?(x(r===o-1,"All SENT items should be at beginning of queue."),r=o,n[o].status=3,n[o].abortReason="set"):(x(n[o].status===0,"Unexpected transaction status in abort"),n[o].unwatcher(),i=i.concat(wi(t.serverSyncTree_,n[o].currentWriteId,!0)),n[o].onComplete&&s.push(n[o].onComplete.bind(null,new Error("set"),!1,null))));r===-1?dT(e,void 0):n.length=r+1,ci(t.eventQueue_,Wo(e),i);for(let o=0;o<s.length;o++)Ho(s[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bM(t){let e="";const n=t.split("/");for(let s=0;s<n.length;s++)if(n[s].length>0){let i=n[s];try{i=decodeURIComponent(i.replace(/\+/g," "))}catch{}e+="/"+i}return e}function IM(t){const e={};t.charAt(0)==="?"&&(t=t.substring(1));for(const n of t.split("&")){if(n.length===0)continue;const s=n.split("=");s.length===2?e[decodeURIComponent(s[0])]=decodeURIComponent(s[1]):jt(`Invalid query segment '${n}' in query '${t}'`)}return e}const km=function(t,e){const n=CM(t),s=n.namespace;n.domain==="firebase.com"&&Ys(n.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),(!s||s==="undefined")&&n.domain!=="localhost"&&Ys("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),n.secure||eP();const i=n.scheme==="ws"||n.scheme==="wss";return{repoInfo:new hP(n.host,n.secure,s,i,e,"",s!==n.subdomain),path:new xe(n.pathString)}},CM=function(t){let e="",n="",s="",i="",r="",o=!0,a="https",c=443;if(typeof t=="string"){let l=t.indexOf("//");l>=0&&(a=t.substring(0,l-1),t=t.substring(l+2));let u=t.indexOf("/");u===-1&&(u=t.length);let h=t.indexOf("?");h===-1&&(h=t.length),e=t.substring(0,Math.min(u,h)),u<h&&(i=bM(t.substring(u,h)));const d=IM(t.substring(Math.min(t.length,h)));l=e.indexOf(":"),l>=0?(o=a==="https"||a==="wss",c=parseInt(e.substring(l+1),10)):l=e.length;const p=e.slice(0,l);if(p.toLowerCase()==="localhost")n="localhost";else if(p.split(".").length<=2)n=p;else{const g=e.indexOf(".");s=e.substring(0,g).toLowerCase(),n=e.substring(g+1),r=s}"ns"in d&&(r=d.ns)}return{host:e,port:c,domain:n,subdomain:s,secure:o,scheme:a,pathString:i,namespace:r}};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cf{constructor(e,n,s,i){this._repo=e,this._path=n,this._queryParams=s,this._orderByCalled=i}get key(){return ae(this._path)?null:ME(this._path)}get ref(){return new ur(this._repo,this._path)}get _queryIdentifier(){const e=pm(this._queryParams),n=rf(e);return n==="{}"?"default":n}get _queryObject(){return pm(this._queryParams)}isEqual(e){if(e=$e(e),!(e instanceof Cf))return!1;const n=this._repo===e._repo,s=UE(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return n&&s&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+FP(this._path)}}class ur extends Cf{constructor(e,n){super(e,n,new hf,!1)}get parent(){const e=FE(this._path);return e===null?null:new ur(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}jx(ur);Hx(ur);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const SM="FIREBASE_DATABASE_EMULATOR_HOST",mh={};let RM=!1;function AM(t,e,n,s,i){let r=s||t.options.databaseURL;r===void 0&&(t.options.projectId||Ys("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),gt("Using default host for project ",t.options.projectId),r=`${t.options.projectId}-default-rtdb.firebaseio.com`);let o=km(r,i),a=o.repoInfo,c,l;typeof process<"u"&&process.env&&(l=process.env[SM]),l?(c=!0,r=`http://${l}?ns=${a.namespace}`,o=km(r,i),a=o.repoInfo):c=!o.repoInfo.secure;const u=i&&c?new rh(rh.OWNER):new uP(t.name,t.options,e);oM("Invalid Firebase Database URL",o),ae(o.path)||Ys("Database URL must point to the root of a Firebase Database (not including a child path).");const h=NM(a,t,u,new lP(t.name,n));return new OM(h,t)}function kM(t,e){const n=mh[e];(!n||n[t.key]!==t)&&Ys(`Database ${e}(${t.repoInfo_}) has already been deleted.`),vM(t),delete n[t.key]}function NM(t,e,n,s){let i=mh[e.name];i||(i={},mh[e.name]=i);let r=i[t.toURLString()];return r&&Ys("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),r=new fM(t,RM,n,s),i[t.toURLString()]=r,r}class OM{constructor(e,n){this._repoInternal=e,this.app=n,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(pM(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new ur(this._repo,Ie())),this._rootInternal}_delete(){return this._rootInternal!==null&&(kM(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&Ys("Cannot call "+e+" on a deleted database.")}}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function DM(t){QD(ni),Cn(new fn("database",(e,{instanceIdentifier:n})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return AM(s,i,r,n)},"PUBLIC").setMultipleInstances(!0)),Vt(Yg,Xg,t),Vt(Yg,Xg,"esm2017")}$n.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};$n.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};DM();/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bT="firebasestorage.googleapis.com",IT="storageBucket",PM=2*60*1e3,xM=10*60*1e3;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qe extends kn{constructor(e,n,s=0){super(eu(e),`Firebase Storage: ${n} (${eu(e)})`),this.status_=s,this.customData={serverResponse:null},this._baseMessage=this.message,Object.setPrototypeOf(this,qe.prototype)}get status(){return this.status_}set status(e){this.status_=e}_codeEquals(e){return eu(e)===this.code}get serverResponse(){return this.customData.serverResponse}set serverResponse(e){this.customData.serverResponse=e,this.customData.serverResponse?this.message=`${this._baseMessage}
${this.customData.serverResponse}`:this.message=this._baseMessage}}var He;(function(t){t.UNKNOWN="unknown",t.OBJECT_NOT_FOUND="object-not-found",t.BUCKET_NOT_FOUND="bucket-not-found",t.PROJECT_NOT_FOUND="project-not-found",t.QUOTA_EXCEEDED="quota-exceeded",t.UNAUTHENTICATED="unauthenticated",t.UNAUTHORIZED="unauthorized",t.UNAUTHORIZED_APP="unauthorized-app",t.RETRY_LIMIT_EXCEEDED="retry-limit-exceeded",t.INVALID_CHECKSUM="invalid-checksum",t.CANCELED="canceled",t.INVALID_EVENT_NAME="invalid-event-name",t.INVALID_URL="invalid-url",t.INVALID_DEFAULT_BUCKET="invalid-default-bucket",t.NO_DEFAULT_BUCKET="no-default-bucket",t.CANNOT_SLICE_BLOB="cannot-slice-blob",t.SERVER_FILE_WRONG_SIZE="server-file-wrong-size",t.NO_DOWNLOAD_URL="no-download-url",t.INVALID_ARGUMENT="invalid-argument",t.INVALID_ARGUMENT_COUNT="invalid-argument-count",t.APP_DELETED="app-deleted",t.INVALID_ROOT_OPERATION="invalid-root-operation",t.INVALID_FORMAT="invalid-format",t.INTERNAL_ERROR="internal-error",t.UNSUPPORTED_ENVIRONMENT="unsupported-environment"})(He||(He={}));function eu(t){return"storage/"+t}function Sf(){const t="An unknown error occurred, please check the error payload for server response.";return new qe(He.UNKNOWN,t)}function MM(t){return new qe(He.OBJECT_NOT_FOUND,"Object '"+t+"' does not exist.")}function LM(t){return new qe(He.QUOTA_EXCEEDED,"Quota for bucket '"+t+"' exceeded, please view quota on https://firebase.google.com/pricing/.")}function FM(){const t="User is not authenticated, please authenticate using Firebase Authentication and try again.";return new qe(He.UNAUTHENTICATED,t)}function UM(){return new qe(He.UNAUTHORIZED_APP,"This app does not have permission to access Firebase Storage on this project.")}function BM(t){return new qe(He.UNAUTHORIZED,"User does not have permission to access '"+t+"'.")}function $M(){return new qe(He.RETRY_LIMIT_EXCEEDED,"Max retry time for operation exceeded, please try again.")}function VM(){return new qe(He.CANCELED,"User canceled the upload/download.")}function jM(t){return new qe(He.INVALID_URL,"Invalid URL '"+t+"'.")}function HM(t){return new qe(He.INVALID_DEFAULT_BUCKET,"Invalid default bucket '"+t+"'.")}function qM(){return new qe(He.NO_DEFAULT_BUCKET,"No default bucket found. Did you set the '"+IT+"' property when initializing the app?")}function WM(){return new qe(He.CANNOT_SLICE_BLOB,"Cannot slice blob for upload. Please retry the upload.")}function KM(){return new qe(He.NO_DOWNLOAD_URL,"The given file does not have any download URLs.")}function zM(t){return new qe(He.UNSUPPORTED_ENVIRONMENT,`${t} is missing. Make sure to install the required polyfills. See https://firebase.google.com/docs/web/environments-js-sdk#polyfills for more information.`)}function _h(t){return new qe(He.INVALID_ARGUMENT,t)}function CT(){return new qe(He.APP_DELETED,"The Firebase app was deleted.")}function GM(t){return new qe(He.INVALID_ROOT_OPERATION,"The operation '"+t+"' cannot be performed on a root reference, create a non-root reference using child, such as .child('file.png').")}function Hr(t,e){return new qe(He.INVALID_FORMAT,"String does not match format '"+t+"': "+e)}function wr(t){throw new qe(He.INTERNAL_ERROR,"Internal error: "+t)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bt{constructor(e,n){this.bucket=e,this.path_=n}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,n){let s;try{s=Bt.makeFromUrl(e,n)}catch{return new Bt(e,"")}if(s.path==="")return s;throw HM(e)}static makeFromUrl(e,n){let s=null;const i="([A-Za-z0-9.\\-_]+)";function r(D){D.path.charAt(D.path.length-1)==="/"&&(D.path_=D.path_.slice(0,-1))}const o="(/(.*))?$",a=new RegExp("^gs://"+i+o,"i"),c={bucket:1,path:3};function l(D){D.path_=decodeURIComponent(D.path)}const u="v[A-Za-z0-9_]+",h=n.replace(/[.]/g,"\\."),d="(/([^?#]*).*)?$",p=new RegExp(`^https?://${h}/${u}/b/${i}/o${d}`,"i"),g={bucket:1,path:3},_=n===bT?"(?:storage.googleapis.com|storage.cloud.google.com)":n,w="([^?#]*)",b=new RegExp(`^https?://${_}/${i}/${w}`,"i"),C=[{regex:a,indices:c,postModify:r},{regex:p,indices:g,postModify:l},{regex:b,indices:{bucket:1,path:2},postModify:l}];for(let D=0;D<C.length;D++){const z=C[D],oe=z.regex.exec(e);if(oe){const ge=oe[z.indices.bucket];let j=oe[z.indices.path];j||(j=""),s=new Bt(ge,j),z.postModify(s);break}}if(s==null)throw jM(e);return s}}class QM{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function JM(t){return t!==void 0}function ZM(t){return typeof t=="object"&&!Array.isArray(t)}function Rf(t){return typeof t=="string"||t instanceof String}function Nm(t){return Af()&&t instanceof Blob}function Af(){return typeof Blob<"u"&&!vC()}function Om(t,e,n,s){if(s<e)throw _h(`Invalid value for '${t}'. Expected ${e} or greater.`);if(s>n)throw _h(`Invalid value for '${t}'. Expected ${n} or less.`)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kf(t,e,n){let s=e;return n==null&&(s=`https://${e}`),`${n}://${s}/v0${t}`}function ST(t){const e=encodeURIComponent;let n="?";for(const s in t)if(t.hasOwnProperty(s)){const i=e(s)+"="+e(t[s]);n=n+i+"&"}return n=n.slice(0,-1),n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function eL(t,e){const n=t>=500&&t<600,i=[408,429].indexOf(t)!==-1,r=e.indexOf(t)!==-1;return n||i||r}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tL{constructor(e,n,s,i,r,o,a,c,l,u,h,d=!0){this.url_=e,this.method_=n,this.headers_=s,this.body_=i,this.successCodes_=r,this.additionalRetryCodes_=o,this.callback_=a,this.errorCallback_=c,this.timeout_=l,this.progressCallback_=u,this.connectionFactory_=h,this.retry=d,this.pendingConnection_=null,this.backoffId_=null,this.canceled_=!1,this.appDelete_=!1,this.promise_=new Promise((p,g)=>{this.resolve_=p,this.reject_=g,this.start_()})}start_(){const e=(s,i)=>{if(i){s(!1,new da(!1,null,!0));return}const r=this.connectionFactory_();this.pendingConnection_=r;const o=a=>{const c=a.loaded,l=a.lengthComputable?a.total:-1;this.progressCallback_!==null&&this.progressCallback_(c,l)};this.progressCallback_!==null&&r.addUploadProgressListener(o),r.send(this.url_,this.method_,this.body_,this.headers_).then(()=>{this.progressCallback_!==null&&r.removeUploadProgressListener(o),this.pendingConnection_=null;const a=r.getErrorCode()===qs.NO_ERROR,c=r.getStatus();if(!a||eL(c,this.additionalRetryCodes_)&&this.retry){const u=r.getErrorCode()===qs.ABORT;s(!1,new da(!1,null,u));return}const l=this.successCodes_.indexOf(c)!==-1;s(!0,new da(l,r))})},n=(s,i)=>{const r=this.resolve_,o=this.reject_,a=i.connection;if(i.wasSuccessCode)try{const c=this.callback_(a,a.getResponse());JM(c)?r(c):r()}catch(c){o(c)}else if(a!==null){const c=Sf();c.serverResponse=a.getErrorText(),this.errorCallback_?o(this.errorCallback_(a,c)):o(c)}else if(i.canceled){const c=this.appDelete_?CT():VM();o(c)}else{const c=$M();o(c)}};this.canceled_?n(!1,new da(!1,null,!0)):this.backoffId_=YM(e,n,this.timeout_)}getPromise(){return this.promise_}cancel(e){this.canceled_=!0,this.appDelete_=e||!1,this.backoffId_!==null&&XM(this.backoffId_),this.pendingConnection_!==null&&this.pendingConnection_.abort()}}class da{constructor(e,n,s){this.wasSuccessCode=e,this.connection=n,this.canceled=!!s}}function nL(t,e){e!==null&&e.length>0&&(t.Authorization="Firebase "+e)}function sL(t,e){t["X-Firebase-Storage-Version"]="webjs/"+(e??"AppManager")}function iL(t,e){e&&(t["X-Firebase-GMPID"]=e)}function rL(t,e){e!==null&&(t["X-Firebase-AppCheck"]=e)}function oL(t,e,n,s,i,r,o=!0){const a=ST(t.urlParams),c=t.url+a,l=Object.assign({},t.headers);return iL(l,e),nL(l,n),sL(l,r),rL(l,s),new tL(c,t.method,l,t.body,t.successCodes,t.additionalRetryCodes,t.handler,t.errorHandler,t.timeout,t.progressCallback,i,o)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function aL(){return typeof BlobBuilder<"u"?BlobBuilder:typeof WebKitBlobBuilder<"u"?WebKitBlobBuilder:void 0}function cL(...t){const e=aL();if(e!==void 0){const n=new e;for(let s=0;s<t.length;s++)n.append(t[s]);return n.getBlob()}else{if(Af())return new Blob(t);throw new qe(He.UNSUPPORTED_ENVIRONMENT,"This browser doesn't seem to support creating Blobs")}}function lL(t,e,n){return t.webkitSlice?t.webkitSlice(e,n):t.mozSlice?t.mozSlice(e,n):t.slice?t.slice(e,n):null}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function uL(t){if(typeof atob>"u")throw zM("base-64");return atob(t)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wn={RAW:"raw",BASE64:"base64",BASE64URL:"base64url",DATA_URL:"data_url"};class tu{constructor(e,n){this.data=e,this.contentType=n||null}}function hL(t,e){switch(t){case wn.RAW:return new tu(RT(e));case wn.BASE64:case wn.BASE64URL:return new tu(AT(t,e));case wn.DATA_URL:return new tu(fL(e),pL(e))}throw Sf()}function RT(t){const e=[];for(let n=0;n<t.length;n++){let s=t.charCodeAt(n);if(s<=127)e.push(s);else if(s<=2047)e.push(192|s>>6,128|s&63);else if((s&64512)===55296)if(!(n<t.length-1&&(t.charCodeAt(n+1)&64512)===56320))e.push(239,191,189);else{const r=s,o=t.charCodeAt(++n);s=65536|(r&1023)<<10|o&1023,e.push(240|s>>18,128|s>>12&63,128|s>>6&63,128|s&63)}else(s&64512)===56320?e.push(239,191,189):e.push(224|s>>12,128|s>>6&63,128|s&63)}return new Uint8Array(e)}function dL(t){let e;try{e=decodeURIComponent(t)}catch{throw Hr(wn.DATA_URL,"Malformed data URL.")}return RT(e)}function AT(t,e){switch(t){case wn.BASE64:{const i=e.indexOf("-")!==-1,r=e.indexOf("_")!==-1;if(i||r)throw Hr(t,"Invalid character '"+(i?"-":"_")+"' found: is it base64url encoded?");break}case wn.BASE64URL:{const i=e.indexOf("+")!==-1,r=e.indexOf("/")!==-1;if(i||r)throw Hr(t,"Invalid character '"+(i?"+":"/")+"' found: is it base64 encoded?");e=e.replace(/-/g,"+").replace(/_/g,"/");break}}let n;try{n=uL(e)}catch(i){throw i.message.includes("polyfill")?i:Hr(t,"Invalid character found")}const s=new Uint8Array(n.length);for(let i=0;i<n.length;i++)s[i]=n.charCodeAt(i);return s}class kT{constructor(e){this.base64=!1,this.contentType=null;const n=e.match(/^data:([^,]+)?,/);if(n===null)throw Hr(wn.DATA_URL,"Must be formatted 'data:[<mediatype>][;base64],<data>");const s=n[1]||null;s!=null&&(this.base64=gL(s,";base64"),this.contentType=this.base64?s.substring(0,s.length-7):s),this.rest=e.substring(e.indexOf(",")+1)}}function fL(t){const e=new kT(t);return e.base64?AT(wn.BASE64,e.rest):dL(e.rest)}function pL(t){return new kT(t).contentType}function gL(t,e){return t.length>=e.length?t.substring(t.length-e.length)===e:!1}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ss{constructor(e,n){let s=0,i="";Nm(e)?(this.data_=e,s=e.size,i=e.type):e instanceof ArrayBuffer?(n?this.data_=new Uint8Array(e):(this.data_=new Uint8Array(e.byteLength),this.data_.set(new Uint8Array(e))),s=this.data_.length):e instanceof Uint8Array&&(n?this.data_=e:(this.data_=new Uint8Array(e.length),this.data_.set(e)),s=e.length),this.size_=s,this.type_=i}size(){return this.size_}type(){return this.type_}slice(e,n){if(Nm(this.data_)){const s=this.data_,i=lL(s,e,n);return i===null?null:new ss(i)}else{const s=new Uint8Array(this.data_.buffer,e,n-e);return new ss(s,!0)}}static getBlob(...e){if(Af()){const n=e.map(s=>s instanceof ss?s.data_:s);return new ss(cL.apply(null,n))}else{const n=e.map(o=>Rf(o)?hL(wn.RAW,o).data:o.data_);let s=0;n.forEach(o=>{s+=o.byteLength});const i=new Uint8Array(s);let r=0;return n.forEach(o=>{for(let a=0;a<o.length;a++)i[r++]=o[a]}),new ss(i,!0)}}uploadData(){return this.data_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function NT(t){let e;try{e=JSON.parse(t)}catch{return null}return ZM(e)?e:null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mL(t){if(t.length===0)return null;const e=t.lastIndexOf("/");return e===-1?"":t.slice(0,e)}function _L(t,e){const n=e.split("/").filter(s=>s.length>0).join("/");return t.length===0?n:t+"/"+n}function OT(t){const e=t.lastIndexOf("/",t.length-2);return e===-1?t:t.slice(e+1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yL(t,e){return e}class Ct{constructor(e,n,s,i){this.server=e,this.local=n||e,this.writable=!!s,this.xform=i||yL}}let fa=null;function vL(t){return!Rf(t)||t.length<2?t:OT(t)}function DT(){if(fa)return fa;const t=[];t.push(new Ct("bucket")),t.push(new Ct("generation")),t.push(new Ct("metageneration")),t.push(new Ct("name","fullPath",!0));function e(r,o){return vL(o)}const n=new Ct("name");n.xform=e,t.push(n);function s(r,o){return o!==void 0?Number(o):o}const i=new Ct("size");return i.xform=s,t.push(i),t.push(new Ct("timeCreated")),t.push(new Ct("updated")),t.push(new Ct("md5Hash",null,!0)),t.push(new Ct("cacheControl",null,!0)),t.push(new Ct("contentDisposition",null,!0)),t.push(new Ct("contentEncoding",null,!0)),t.push(new Ct("contentLanguage",null,!0)),t.push(new Ct("contentType",null,!0)),t.push(new Ct("metadata","customMetadata",!0)),fa=t,fa}function wL(t,e){function n(){const s=t.bucket,i=t.fullPath,r=new Bt(s,i);return e._makeStorageReference(r)}Object.defineProperty(t,"ref",{get:n})}function EL(t,e,n){const s={};s.type="file";const i=n.length;for(let r=0;r<i;r++){const o=n[r];s[o.local]=o.xform(s,e[o.server])}return wL(s,t),s}function PT(t,e,n){const s=NT(e);return s===null?null:EL(t,s,n)}function TL(t,e,n,s){const i=NT(e);if(i===null||!Rf(i.downloadTokens))return null;const r=i.downloadTokens;if(r.length===0)return null;const o=encodeURIComponent;return r.split(",").map(l=>{const u=t.bucket,h=t.fullPath,d="/b/"+o(u)+"/o/"+o(h),p=kf(d,n,s),g=ST({alt:"media",token:l});return p+g})[0]}function bL(t,e){const n={},s=e.length;for(let i=0;i<s;i++){const r=e[i];r.writable&&(n[r.server]=t[r.local])}return JSON.stringify(n)}class xT{constructor(e,n,s,i){this.url=e,this.method=n,this.handler=s,this.timeout=i,this.urlParams={},this.headers={},this.body=null,this.errorHandler=null,this.progressCallback=null,this.successCodes=[200],this.additionalRetryCodes=[]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function MT(t){if(!t)throw Sf()}function IL(t,e){function n(s,i){const r=PT(t,i,e);return MT(r!==null),r}return n}function CL(t,e){function n(s,i){const r=PT(t,i,e);return MT(r!==null),TL(r,i,t.host,t._protocol)}return n}function LT(t){function e(n,s){let i;return n.getStatus()===401?n.getErrorText().includes("Firebase App Check token is invalid")?i=UM():i=FM():n.getStatus()===402?i=LM(t.bucket):n.getStatus()===403?i=BM(t.path):i=s,i.status=n.getStatus(),i.serverResponse=s.serverResponse,i}return e}function SL(t){const e=LT(t);function n(s,i){let r=e(s,i);return s.getStatus()===404&&(r=MM(t.path)),r.serverResponse=i.serverResponse,r}return n}function RL(t,e,n){const s=e.fullServerUrl(),i=kf(s,t.host,t._protocol),r="GET",o=t.maxOperationRetryTime,a=new xT(i,r,CL(t,n),o);return a.errorHandler=SL(e),a}function AL(t,e){return t&&t.contentType||e&&e.type()||"application/octet-stream"}function kL(t,e,n){const s=Object.assign({},n);return s.fullPath=t.path,s.size=e.size(),s.contentType||(s.contentType=AL(null,e)),s}function NL(t,e,n,s,i){const r=e.bucketOnlyServerUrl(),o={"X-Goog-Upload-Protocol":"multipart"};function a(){let C="";for(let D=0;D<2;D++)C=C+Math.random().toString().slice(2);return C}const c=a();o["Content-Type"]="multipart/related; boundary="+c;const l=kL(e,s,i),u=bL(l,n),h="--"+c+`\r
...
\r
`,d=`\r
--`+c+"--",p=ss.getBlob(h,s,d);if(p===null)throw WM();const g={name:l.fullPath},_=kf(r,t.host,t._protocol),w="POST",b=t.maxUploadRetryTime,k=new xT(_,w,IL(t,n),b);return k.urlParams=g,k.headers=o,k.body=p.uploadData(),k.errorHandler=LT(e),k}class OL{constructor(){this.sent_=!1,this.xhr_=new XMLHttpRequest,this.initXhr(),this.errorCode_=qs.NO_ERROR,this.sendPromise_=new Promise(e=>{this.xhr_.addEventListener("abort",()=>{this.errorCode_=qs.ABORT,e()}),this.xhr_.addEventListener("error",()=>{this.errorCode_=qs.NETWORK_ERROR,e()}),this.xhr_.addEventListener("load",()=>{e()})})}send(e,n,s,i){if(this.sent_)throw wr("cannot .send() more than once");if(this.sent_=!0,this.xhr_.open(n,e,!0),i!==void 0)for(const r in i)i.hasOwnProperty(r)&&this.xhr_.setRequestHeader(r,i[r].toString());return s!==void 0?this.xhr_.send(s):this.xhr_.send(),this.sendPromise_}getErrorCode(){if(!this.sent_)throw wr("cannot .getErrorCode() before sending");return this.errorCode_}getStatus(){if(!this.sent_)throw wr("cannot .getStatus() before sending");try{return this.xhr_.status}catch{return-1}}getResponse(){if(!this.sent_)throw wr("cannot .getResponse() before sending");return this.xhr_.response}getErrorText(){if(!this.sent_)throw wr("cannot .getErrorText() before sending");return this.xhr_.statusText}abort(){this.xhr_.abort()}getResponseHeader(e){return this.xhr_.getResponseHeader(e)}addUploadProgressListener(e){this.xhr_.upload!=null&&this.xhr_.upload.addEventListener("progress",e)}removeUploadProgressListener(e){this.xhr_.upload!=null&&this.xhr_.upload.removeEventListener("progress",e)}}class DL extends OL{initXhr(){this.xhr_.responseType="text"}}function FT(){return new DL}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ei{constructor(e,n){this._service=e,n instanceof Bt?this._location=n:this._location=Bt.makeFromUrl(n,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,n){return new ei(e,n)}get root(){const e=new Bt(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return OT(this._location.path)}get storage(){return this._service}get parent(){const e=mL(this._location.path);if(e===null)return null;const n=new Bt(this._location.bucket,e);return new ei(this._service,n)}_throwIfRoot(e){if(this._location.path==="")throw GM(e)}}function PL(t,e,n){t._throwIfRoot("uploadBytes");const s=NL(t.storage,t._location,DT(),new ss(e,!0),n);return t.storage.makeRequestWithTokens(s,FT).then(i=>({metadata:i,ref:t}))}function xL(t){t._throwIfRoot("getDownloadURL");const e=RL(t.storage,t._location,DT());return t.storage.makeRequestWithTokens(e,FT).then(n=>{if(n===null)throw KM();return n})}function ML(t,e){const n=_L(t._location.path,e),s=new Bt(t._location.bucket,n);return new ei(t.storage,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function LL(t){return/^[A-Za-z]+:\/\//.test(t)}function FL(t,e){return new ei(t,e)}function UT(t,e){if(t instanceof Nf){const n=t;if(n._bucket==null)throw qM();const s=new ei(n,n._bucket);return e!=null?UT(s,e):s}else return e!==void 0?ML(t,e):t}function UL(t,e){if(e&&LL(e)){if(t instanceof Nf)return FL(t,e);throw _h("To use ref(service, url), the first argument must be a Storage instance.")}else return UT(t,e)}function Dm(t,e){const n=e==null?void 0:e[IT];return n==null?null:Bt.makeFromBucketSpec(n,t)}function BL(t,e,n,s={}){t.host=`${e}:${n}`,t._protocol="http";const{mockUserToken:i}=s;i&&(t._overrideAuthToken=typeof i=="string"?i:iy(i,t.app.options.projectId))}class Nf{constructor(e,n,s,i,r){this.app=e,this._authProvider=n,this._appCheckProvider=s,this._url=i,this._firebaseVersion=r,this._bucket=null,this._host=bT,this._protocol="https",this._appId=null,this._deleted=!1,this._maxOperationRetryTime=PM,this._maxUploadRetryTime=xM,this._requests=new Set,i!=null?this._bucket=Bt.makeFromBucketSpec(i,this._host):this._bucket=Dm(this._host,this.app.options)}get host(){return this._host}set host(e){this._host=e,this._url!=null?this._bucket=Bt.makeFromBucketSpec(this._url,e):this._bucket=Dm(e,this.app.options)}get maxUploadRetryTime(){return this._maxUploadRetryTime}set maxUploadRetryTime(e){Om("time",0,Number.POSITIVE_INFINITY,e),this._maxUploadRetryTime=e}get maxOperationRetryTime(){return this._maxOperationRetryTime}set maxOperationRetryTime(e){Om("time",0,Number.POSITIVE_INFINITY,e),this._maxOperationRetryTime=e}async _getAuthToken(){if(this._overrideAuthToken)return this._overrideAuthToken;const e=this._authProvider.getImmediate({optional:!0});if(e){const n=await e.getToken();if(n!==null)return n.accessToken}return null}async _getAppCheckToken(){const e=this._appCheckProvider.getImmediate({optional:!0});return e?(await e.getToken()).token:null}_delete(){return this._deleted||(this._deleted=!0,this._requests.forEach(e=>e.cancel()),this._requests.clear()),Promise.resolve()}_makeStorageReference(e){return new ei(this,e)}_makeRequest(e,n,s,i,r=!0){if(this._deleted)return new QM(CT());{const o=oL(e,this._appId,s,i,n,this._firebaseVersion,r);return this._requests.add(o),o.getPromise().then(()=>this._requests.delete(o),()=>this._requests.delete(o)),o}}async makeRequestWithTokens(e,n){const[s,i]=await Promise.all([this._getAuthToken(),this._getAppCheckToken()]);return this._makeRequest(e,n,s,i).getPromise()}}const Pm="@firebase/storage",xm="0.11.1";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const BT="storage";function $T(t,e,n){return t=$e(t),PL(t,e,n)}function ys(t){return t=$e(t),xL(t)}function vs(t,e){return t=$e(t),UL(t,e)}function ti(t=Dc(),e){t=$e(t);const s=Oc(t,BT).getImmediate({identifier:e}),i=ny("storage");return i&&$L(s,...i),s}function $L(t,e,n,s={}){BL(t,e,n,s)}function VL(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),s=t.getProvider("auth-internal"),i=t.getProvider("app-check-internal");return new Nf(n,s,i,e,ni)}function jL(){Cn(new fn(BT,VL,"PUBLIC").setMultipleInstances(!0)),Vt(Pm,xm,""),Vt(Pm,xm,"esm2017")}jL();const nu=new WeakMap;function VT(t,e){return nu.has(e)||nu.set(e,t||{f:{},r:{},s:{},u:{}}),nu.get(e)}function HL(t,e,n,s){if(!t)return n;const[i,r]=jT(t);if(!i)return n;const o=VT(void 0,s)[i]||{},a=e||r;return a&&a in o?o[a]:n}function qL(t,e,n,s){if(!t)return;const[i,r]=jT(t);if(!i)return;const o=VT(void 0,s)[i],a=e||r;if(a)return n.then(c=>{o[a]=c}),a}function jT(t){return BD(t)||$D(t)?["f",t.path]:VD(t)?["r",t.toString()]:jD(t)?["s",t.toString()]:[]}const su=new WeakMap;function WL(t,e,n){const s=pl();su.has(s)||su.set(s,new Map);const i=su.get(s),r=qL(e,n,t,s);return r&&i.set(r,t),r?()=>i.delete(r):Fn}const KL={toFirestore(t){return t},fromFirestore(t,e){return t.exists()?Object.defineProperties(t.data(e),{id:{value:t.id}}):null}};function yh(t,e,n,s){if(!FD(t))return[t,{}];const i=[{},{}],r=Object.keys(n).reduce((a,c)=>{const l=n[c];return a[l.path]=l.data(),a},{});function o(a,c,l,u){c=c||{};const[h,d]=u;Object.getOwnPropertyNames(a).forEach(p=>{const g=Object.getOwnPropertyDescriptor(a,p);g&&!g.enumerable&&Object.defineProperty(h,p,g)});for(const p in a){const g=a[p];if(g==null||g instanceof Date||g instanceof Ye||g instanceof cl)h[p]=g;else if(sf(g)){const _=l+p;h[p]=_ in n?c[p]:g.path,d[_]=g.converter?g:g.withConverter(s.converter)}else if(Array.isArray(g)){h[p]=Array(g.length);for(let _=0;_<g.length;_++){const w=g[_];w&&w.path in r&&(h[p][_]=r[w.path])}o(g,c[p]||h[p],l+p+".",[h[p],d])}else oi(g)?(h[p]={},o(g,c[p],l+p+".",[h[p],d])):h[p]=g}}return o(t,e,"",i),i}const Of={reset:!1,wait:!0,maxRefDepth:2,converter:KL,snapshotOptions:{serverTimestamps:"estimate"}};function dc(t){for(const e in t)t[e].unsub()}function vh(t,e,n,s,i,r,o,a,c){const[l,u]=yh(s.data(t.snapshotOptions),nf(e,n),i,t);r.set(e,n,l),wh(t,e,n,i,u,r,o,a,c)}function zL({ref:t,target:e,path:n,depth:s,resolve:i,reject:r,ops:o},a){const c=Object.create(null);let l=Fn;return a.once?kw(t).then(u=>{u.exists()?vh(a,e,n,u,c,o,s,i,r):(o.set(e,n,null),i())}).catch(r):l=Hd(t,u=>{u.exists()?vh(a,e,n,u,c,o,s,i,r):(o.set(e,n,null),i())},r),()=>{l(),dc(c)}}function wh(t,e,n,s,i,r,o,a,c){const l=Object.keys(i);if(Object.keys(s).filter(_=>l.indexOf(_)<0).forEach(_=>{s[_].unsub(),delete s[_]}),!l.length||++o>t.maxRefDepth)return a(n);let h=0;const d=l.length,p=Object.create(null);function g(_){_ in p&&++h>=d&&a(n)}l.forEach(_=>{const w=s[_],b=i[_],k=`${n}.${_}`;if(p[k]=!0,w)if(w.path!==b.path)w.unsub();else return;s[_]={data:()=>nf(e,k),unsub:zL({ref:b,target:e,path:k,depth:o,ops:r,resolve:g.bind(null,k),reject:c},t),path:b.path}})}function GL(t,e,n,s,i,r){const o=Object.assign({},Of,r),{snapshotListenOptions:a,snapshotOptions:c,wait:l,once:u}=o,h="value";let d=$t(l?[]:t.value);l||n.set(t,h,[]);const p=s;let g,_=Fn;const w=[],b={added:({newIndex:C,doc:D})=>{w.splice(C,0,Object.create(null));const z=w[C],[oe,ge]=yh(D.data(c),void 0,z,o);n.add(se(d),C,oe),wh(o,d,`${h}.${C}`,z,ge,n,0,s.bind(null,D),i)},modified:({oldIndex:C,newIndex:D,doc:z})=>{const oe=se(d),ge=w[C],j=oe[C],[Ce,we]=yh(z.data(c),j,ge,o);w.splice(D,0,ge),n.remove(oe,C),n.add(oe,D,Ce),wh(o,d,`${h}.${D}`,ge,we,n,0,s,i)},removed:({oldIndex:C})=>{const D=se(d);n.remove(D,C),dc(w.splice(C,1)[0])}};function k(C){const D=C.docChanges(a);if(!g&&D.length){g=!0;let z=0;const oe=D.length,ge=Object.create(null);for(let j=0;j<oe;j++)ge[D[j].doc.id]=!0;s=j=>{j&&j.id in ge&&++z>=oe&&(l&&(n.set(t,h,se(d)),d=t),p(se(d)),s=Fn)}}D.forEach(z=>{b[z.type](z)}),D.length||(l&&(n.set(t,h,se(d)),d=t),s(se(d)))}return u?LN(e).then(k).catch(i):_=Hd(e,k,i),C=>{if(_(),C){const D=typeof C=="function"?C():[];n.set(t,h,D)}w.forEach(dc)}}function QL(t,e,n,s,i,r){const o=Object.assign({},Of,r),a="value",c=Object.create(null);s=HD(s,()=>nf(t,a));let l=Fn;function u(h){h.exists()?vh(o,t,a,h,c,n,0,s,i):(n.set(t,a,null),s(null))}return o.once?kw(e).then(u).catch(i):l=Hd(e,u,i),h=>{if(l(),h){const d=typeof h=="function"?h():null;n.set(t,a,d)}dc(c)}}function YL(t,e){let n=Fn;const s=Object.assign({},Of,e),i=se(t),r=s.target||$t();qD()&&(s.once=!0),r.value=HL(i,s.ssrKey,r.value,pl());let o=r.value===void 0;const a=$t(!1),c=$t(),l=i_(),u=jm();let h=Fn;function d(){let _=se(t);const w=new Promise((b,k)=>{if(n(s.reset),!_)return n=Fn,b(null);a.value=o,o=!0,_.converter||(_=_.withConverter(s.converter)),n=(sf(_)?QL:GL)(r,_,XL,b,k,s)}).catch(b=>(l.value===w&&(c.value=b),Promise.reject(b))).finally(()=>{l.value===w&&(a.value=!1)});l.value=w}let p=Fn;Je(t)&&(p=kr(t,d)),d(),i&&(h=WL(l.value,i,s.ssrKey)),Cc()&&b_(()=>l.value),u&&rb(g);function g(_=s.reset){p(),h(),n(_)}return Object.defineProperties(r,{error:{get:()=>c},data:{get:()=>r},pending:{get:()=>a},promise:{get:()=>l},stop:{get:()=>g}})}const XL={set:(t,e,n)=>MD(t,e,n),add:(t,e,n)=>t.splice(e,0,n),remove:(t,e)=>t.splice(e,1)};function Ko(t,e){return YL(t,{target:$t([]),...e})}function hr(t){return mw(pl(t))}function JL(t){return(e,n)=>{const s=WD(e,n).run(()=>$t(t));KD.set(e,s),GD(s,e)}}function ZL(t,{firebaseApp:e,modules:n=[]}){t.provide(hE,e);for(const s of n)t.use(s.bind(null,e))}const eF={class:"green"},tF={key:0},nF=["src","id"],sF=["onClick"],iF=y("br",null,null,-1),rF=y("br",null,null,-1),oF={__name:"ofimatica",props:{msg:{type:String,required:!0}},setup(t){const e=hr(),n=Ko(qi(e,"cursos")),s=ti();function i(o,a){const c=vs(s,o);ys(c).then(l=>{document.getElementById(a).setAttribute("src",l)}).catch(l=>{})}function r(o){sessionStorage.setItem(o.nombre,JSON.stringify(o));for(var a=0;a<sessionStorage.length;a++)sessionStorage.key(a)}return(o,a)=>{const c=Tc("router-link");return _e(),Pe(Me,null,[y("h1",eF,Se(t.msg),1),y("ul",null,[(_e(!0),Pe(Me,null,Xi(se(n),l=>(_e(),Pe("section",{key:l.id},[l.categoria=="ofimatica"?(_e(),Pe("div",tF,[y("li",null,[Ve(c,{to:"/detalle_curso/"+l.nombre},{default:Nt(()=>[me(Se(l.nombre),1)]),_:2},1032,["to"])]),y("ul",null,[y("li",null,Se(l.categoria),1),y("li",null,Se(l.horas)+" horas ",1),y("img",{src:i(l.imagen,l.nombre),id:l.nombre},null,8,nF),y("li",null,[y("button",{onClick:u=>r(l)},"Inscribirse",8,sF)])]),me(),iF,rF])):is("",!0)]))),128))])],64)}}},aF={class:"green"},cF={key:0},lF=["src","id"],uF=["onClick"],hF=y("br",null,null,-1),dF=y("br",null,null,-1),fF={__name:"programacion",props:{msg:{type:String,required:!0}},setup(t){const e=hr(),n=Ko(qi(e,"cursos")),s=ti();function i(o,a){const c=vs(s,o);ys(c).then(l=>{document.getElementById(a).setAttribute("src",l)}).catch(l=>{})}function r(o){sessionStorage.setItem(o.nombre,JSON.stringify(o));for(var a=0;a<sessionStorage.length;a++)sessionStorage.key(a)}return(o,a)=>{const c=Tc("router-link");return _e(),Pe(Me,null,[y("h1",aF,Se(t.msg),1),y("ul",null,[(_e(!0),Pe(Me,null,Xi(se(n),l=>(_e(),Pe("section",{key:l.id},[l.categoria=="programacion"?(_e(),Pe("div",cF,[y("li",null,[Ve(c,{to:"/detalle_curso/"+l.nombre},{default:Nt(()=>[me(Se(l.nombre),1)]),_:2},1032,["to"])]),y("ul",null,[y("li",null,Se(l.categoria),1),y("li",null,Se(l.horas)+" horas ",1),y("img",{src:i(l.imagen,l.nombre),id:l.nombre},null,8,lF),y("li",null,[y("button",{onClick:u=>r(l)},"Inscribirse",8,uF)])]),me(),hF,dF])):is("",!0)]))),128))])],64)}}},pF={class:"green"},gF={key:0},mF=["src","id"],_F=["onClick"],yF=y("br",null,null,-1),vF=y("br",null,null,-1),wF={__name:"sos",props:{msg:{type:String,required:!0}},setup(t){const e=hr(),n=Ko(qi(e,"cursos")),s=ti();function i(o,a){const c=vs(s,o);ys(c).then(l=>{document.getElementById(a).setAttribute("src",l)}).catch(l=>{})}function r(o){sessionStorage.setItem(o.nombre,JSON.stringify(o));for(var a=0;a<sessionStorage.length;a++)sessionStorage.key(a)}return(o,a)=>{const c=Tc("router-link");return _e(),Pe(Me,null,[y("h1",pF,Se(t.msg),1),y("ul",null,[(_e(!0),Pe(Me,null,Xi(se(n),l=>(_e(),Pe("section",{key:l.id},[l.categoria=="sos"?(_e(),Pe("div",gF,[y("li",null,[Ve(c,{to:"/detalle_curso/"+l.nombre},{default:Nt(()=>[me(Se(l.nombre),1)]),_:2},1032,["to"])]),y("ul",null,[y("li",null,Se(l.categoria),1),y("li",null,Se(l.horas)+" horas ",1),y("img",{src:i(l.imagen,l.nombre),id:l.nombre},null,8,mF),y("li",null,[y("button",{onClick:u=>r(l)},"Inscribirse",8,_F)])]),me(),yF,vF])):is("",!0)]))),128))])],64)}}},EF={key:0},TF={border:"1"},bF={colspan:"5"},IF={class:"green"},CF=y("tr",null,[y("th",{style:{width:"100px"}},"Categoría"),y("th",{style:{width:"80px"}},"Horas"),y("th",{style:{width:"210px"}},"Imagen"),y("th",{style:{width:"150px"}},"Pdf"),y("th",{style:{width:"100px"}},"Inscribirse")],-1),SF=["src"],RF=["href"],AF=y("td",null,[y("button",null,"Inscribirse")],-1),kF={__name:"detalle_curso",setup(t){const e=hr(),n=Ko(qi(e,"cursos"));var s=Y_().params.nombre,i=s+".png",r=s+".pdf";const o=ti();function a(){const l=vs(o,i);ys(l).then(u=>{document.getElementById("ima").setAttribute("src",u)}).catch(u=>{})}function c(){const l=vs(o,r);ys(l).then(u=>{document.getElementById("pdf").setAttribute("href",u)}).catch(u=>{})}return a(),c(),(l,u)=>(_e(!0),Pe(Me,null,Xi(se(n),h=>(_e(),Pe("section",{key:h.nombre},[h.nombre==l.$route.params.nombre?(_e(),Pe("div",EF,[y("table",TF,[y("thead",null,[y("tr",null,[y("th",bF,[y("h1",IF,Se(h.nombre),1)])]),CF]),y("tbody",null,[y("tr",null,[y("td",null,Se(h.categoria),1),y("td",null,Se(h.horas)+" horas ",1),y("td",null,[y("img",{src:l.imagen,id:"ima"},null,8,SF)]),y("td",null,[y("a",{href:l.pdf,id:"pdf",target:"_blank"},Se(h.nombre)+".pdf",9,RF)]),AF])])])])):is("",!0)]))),128))}},NF={class:"green"},OF=y("label",{for:"categoria"},"Categoría: ",-1),DF=y("input",{type:"text",name:"categoria",id:"categoria"},null,-1),PF=y("br",null,null,-1),xF=y("label",{for:"nombre"},"Nombre: ",-1),MF=y("input",{type:"text",name:"nombre",id:"nombre"},null,-1),LF=y("br",null,null,-1),FF=y("label",{for:"horas"},"Horas: ",-1),UF=y("input",{type:"number",name:"horas",id:"horas",min:"0"},null,-1),BF=y("br",null,null,-1),$F=y("label",{for:"imagen"},"Imagen: ",-1),VF=y("br",null,null,-1),jF={__name:"editar_curso",props:{msg:{type:String,required:!0}},setup(t){const e=hr();var n=Y_().params.id;const s=Ld(e,"cursos",n);function i(){let a=document.getElementById("categoria").value,c=document.getElementById("nombre").value,l=document.getElementById("horas").value;a!=""&&c!=""&&l!=""&&a!=""&&FN(s,{categoria:a,nombre:c,horas:l,imagen:r.value.files[0].name})}let r=$t("");function o(){const a=ti(),c=vs(a,r.value.files[0].name);$T(c,r.value.files[0]).then(l=>{console.log("Uploaded a blob or file!"),ys(c).then(u=>{console.log(u)})})}return(a,c)=>(_e(),Pe(Me,null,[y("h1",NF,Se(t.msg),1),y("fieldset",null,[y("legend",null,[y("h2",null,"Curso "+Se(se(n)),1)]),OF,DF,me(),PF,xF,MF,me(),LF,FF,UF,me(),BF,$F,y("input",{type:"file",name:"",accept:"image/*",ref_key:"file",ref:r,onChange:o},null,544),me(),VF,y("input",{type:"submit",onClick:i,value:"Editar curso"})])],64))}},HF={class:"green"},qF=y("p",null,"Los cursos inscritos están en la consola",-1),WF={__name:"miscursos",props:{msg:{type:String,required:!0}},setup(t){const e=[];for(let n=0;n<sessionStorage.length;n++){let s=sessionStorage.key(n);e[s]=JSON.parse(sessionStorage.getItem(s))}return console.log(e),(n,s)=>(_e(),Pe(Me,null,[y("h1",HF,Se(t.msg),1),qF,y("section",null,[(_e(),Pe(Me,null,Xi(e,i=>y("div",null,[y("p",null,Se(e[i]),1)])),64))])],64))}},KF={class:"green"},zF=y("legend",null,[y("h2",null,"Añadir curso")],-1),GF=y("label",{for:"categoria"},"Categoría: ",-1),QF=y("input",{type:"text",name:"categoria",id:"categoria"},null,-1),YF=y("br",null,null,-1),XF=y("label",{for:"nombre"},"Nombre: ",-1),JF=y("input",{type:"text",name:"nombre",id:"nombre"},null,-1),ZF=y("br",null,null,-1),eU=y("label",{for:"horas"},"Horas: ",-1),tU=y("input",{type:"number",name:"horas",id:"horas",min:"0"},null,-1),nU=y("br",null,null,-1),sU=y("label",{for:"imagen"},"Imagen: ",-1),iU=y("br",null,null,-1),rU=y("br",null,null,-1),oU=["onClick"],aU=["src","id"],cU=y("br",null,null,-1),lU=y("br",null,null,-1),uU={__name:"administracion",props:{msg:{type:String,required:!0}},setup(t){const e=hr(),n=Ko(qi(e,"cursos")),s=ti();function i(l,u){const h=vs(s,l);ys(h).then(d=>{document.getElementById(u).setAttribute("src",d)}).catch(d=>{})}let r=$t("");function o(){const l=ti(),u=vs(l,r.value.files[0].name);$T(u,r.value.files[0]).then(h=>{console.log("Uploaded a blob or file!"),ys(u).then(d=>{console.log(d)})})}function a(){let l=document.getElementById("categoria").value,u=document.getElementById("nombre").value,h=document.getElementById("horas").value;l!=""&&u!=""&&h!=""&&l!=""&&BN(qi(e,"cursos"),{categoria:l,nombre:u,horas:h,imagen:r.value.files[0].name})}function c(l){UN(Ld(e,"cursos",l))}return(l,u)=>{const h=Tc("router-link");return _e(),Pe(Me,null,[y("h1",KF,Se(t.msg),1),y("fieldset",null,[zF,GF,QF,me(),YF,XF,JF,me(),ZF,eU,tU,me(),nU,sU,y("input",{type:"file",name:"",accept:"image/*",ref_key:"file",ref:r,onChange:o},null,544),me(),iU,y("input",{type:"submit",onClick:a,value:"Añadir curso"})]),me(),rU,y("ul",null,[(_e(!0),Pe(Me,null,Xi(se(n),d=>(_e(),Pe("section",{key:d.id},[Ve(h,{to:"/detalle_curso/"+d.nombre},{default:Nt(()=>[me(Se(d.nombre),1)]),_:2},1032,["to"]),y("ul",null,[y("li",null,Se(d.id),1),y("li",null,Se(d.categoria),1),y("li",null,Se(d.horas)+" horas ",1),y("li",null,[Ve(h,{to:"/editar_curso/"+d.id},{default:Nt(()=>[me("Editar curso")]),_:2},1032,["to"])]),y("li",null,[y("button",{onClick:p=>c(d.id)},"Borrar curso",8,oU)]),y("img",{src:i(d.imagen,d.nombre),id:d.nombre},null,8,aU)]),me(),cU,lU]))),128))])],64)}}};const hU=[{path:"/",component:X1,props:{msg:"Página de inicio"}},{path:"/:pathMatch(.*)*",name:"NotFound",component:tD},{path:"/registro",component:uD,props:{msg:"Registro de usuario"}},{path:"/administracion",component:uU,props:{msg:"Administración"},beforeEnter:(t,e)=>Eh},{path:"/ofimatica",component:oF,props:{msg:"Ofimática"}},{path:"/programacion",component:fF,props:{msg:"Programación"}},{path:"/sos",component:wF,props:{msg:"SOs"}},{path:"/detalle_curso/:nombre",component:kF},{path:"/editar_curso/:id",component:jF,props:{msg:"Editar curso"}},{path:"/miscursos",component:WF,props:{msg:"Mis cursos"}}],HT=lC({history:R0(),routes:hU}),Df=c0(q1);let Eh=!1;Xw(ki,t=>{t?(t.uid,Eh=!0):(Eh=!1,HT.push("/"))});Df.use(HT);Df.use(ZL,{firebaseApp:tf,modules:[JL()]});Df.mount("#app");
